...
\begin{document}
	...
	\begin{figure}[H]
		\begin{tikzpicture}
			...
			\draw[pattern=north west lines, pattern color=black] (\xtwo+\radrp,\ytwo-\radrp) rectangle (\xtwo-\radrp,\ytwo+\radrp); 
			...
			\draw[line width=\width](\xtwo-\radrp+0.01,\ytwo-0.5) -- (\dx-0.4,\dy);
