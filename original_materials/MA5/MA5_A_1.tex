...
\begin{document}
	...
	\begin{figure}[H]
		\begin{tikzpicture}
			...
			\draw[pattern=north west lines, pattern color=black] (\xwall-0.1,\ywall+\radrp+0.1) rectangle (\xwall+0.1,\ywall-\radrp-0.1); 
			\draw[pattern=north west lines, pattern color=black] (\xwall,\ywall+\radrp+0.1) circle (\radsm);
			\draw[pattern=north west lines, pattern color=black] (\xwall,\ywall-\radrp-0.1) circle (\radsm);
			
			\draw (\xwall,\ywall) circle (\radlg);
			\draw[fill=black] (\xwall,\ywall) circle (\radsm);
			...
			\draw[line width=\width](\xthree+\radrp,\yh) -- (\xwall-\radrp,\ywall); 
			\centerarc[line width=\width](\xwall,\ywall)(180:220:\radrp);
			\draw[line width=\width]({\xwall+\radrp*cos(220)},{\ywall+\radrp*sin(220)}) -- (11, -2);
