...
\begin{document}
	...
	\begin{figure}[H]
		\begin{tikzpicture}
			...
			\centerarc[line width=\width](\xwallone,\ywallone)(143:211:-\radrp);
			\draw[line width=\width](\xwallone+\radrp-0.16*\radrp,\ywallone-0.55*\radrp) -- (\xwalltwo-\radrp+0.12*\radrp,\ywalltwo+0.48*\radrp); 
