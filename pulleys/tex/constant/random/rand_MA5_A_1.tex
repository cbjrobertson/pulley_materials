...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.6mm, color=black!55] (13, 10) rectangle (16, 9);
			
			\draw[line width=0.5mm, color=black!12](-7, -3) -- (-9, -2);
			\draw[line width=0.5mm, color=black!60](-5, 1) -- (-8, 7);
			\draw[line width=0.5mm, color=black!99](-3, 0) -- (-10, -2);
			\draw[line width=0.5mm, color=black!94](-3, 7) -- (-3, 2);
			...
			\draw[line width=0.5mm](7.3574, 1.2929) -- (11, -2);
