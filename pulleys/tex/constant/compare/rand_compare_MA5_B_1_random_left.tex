	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[line width=0.5mm](3.5,11.5) -- (4,12) --  (4.5,11.5);
				\draw[line width=0.5mm](3,11) --  (3.5,11.5) -- (4,11) -- (4.5,11.5) -- (5,11);
				\draw[fill=black!50] (3, 11) rectangle (5, 9);
				
				\draw[line width = 0.5mm] (-2,8) -- (-2,13);
				\centerarc[line width = 0.5mm](-1,13)(0:180:1);
				\draw[line width = 0.5mm] (0,13) -- (0,10);
				
				\node at (-3, 5) {\scriptsize \Strichmaxerl[10][8][62]};
				\draw[fill=black] (-6, 3.9) rectangle (-2, 3.8);
