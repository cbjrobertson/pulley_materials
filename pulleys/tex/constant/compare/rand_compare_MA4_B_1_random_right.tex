	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[pattern=north west lines, pattern color=black] (-2.1,0.5) rectangle (-1.9,-2.5);
				...
				\draw[line width=0.5mm](3.5,-0.5) -- (4,2) --  (4.5,-0.5);
				\draw[line width=0.5mm](3,-1) --  (3.5,-0.5) -- (4,-1) -- (4.5,-0.5) -- (5,-1);
				\draw[fill=black!50] (3, -1) rectangle (5, -3);
				
				\draw[line width = 0.5mm] (0,7) -- (3,7);
				\centerarc[line width = 0.5mm](0,6)(90:180:1);
				\draw[line width = 0.5mm] (-1,6) -- (-1,0);
				\centerarc[line width = 0.5mm](0,0)(180:360:1);
				\draw[line width = 0.5mm] (1,0) -- (1,4);
				\centerarc[line width = 0.5mm](2,4)(0:180:1);
				\draw[line width = 0.5mm] (3,4) -- (3,3);
				
				\node at (5, 6) {\scriptsize \Strichmaxerl[10][34][93]};
