	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[line width=0.5mm](0.5,11.5) -- (1,14) --  (1.5,11.5);
				\draw[line width=0.5mm](0,11) --  (0.5,11.5) -- (1,11) -- (1.5,11.5) -- (2,11);
				\draw[fill=black!50] (0, 11) rectangle (2, 9);
				
				\draw[line width = 0.5mm] (4,6) -- (4,11);
				\centerarc[line width = 0.5mm](5,11)(0:180:1);
				\draw[line width = 0.5mm] (6,11) -- (6,8);
				\centerarc[line width = 0.5mm](7,8)(270:180:1);
				\draw[line width = 0.5mm] (7,7) -- (8,7);
				
				\node at (6, 11) {\scriptsize \Strichmaxerl[10][148][40]};
				\draw[fill=black] (3, 9.9) rectangle (7, 9.8);
