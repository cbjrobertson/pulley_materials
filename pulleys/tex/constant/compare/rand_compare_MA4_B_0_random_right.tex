	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[fill=black!50] (7,8) circle (0.1);
				\draw[line width=0.5mm](6.5,1.5) -- (7,8) --  (7.5,1.5);
				\draw[line width=0.5mm](6,1) --  (6.5,1.5) -- (7,1) -- (7.5,1.5) -- (8,1);
				\draw[fill=black!50] (6, 1) rectangle (8, -1);
				
				\draw[line width = 0.5mm] (3,7) -- (6,7);
				\centerarc[line width = 0.5mm](3,6)(90:180:1);
				\draw[line width = 0.5mm] (2,6) -- (2,0);
				
				\node at (0, 5) {\scriptsize \Strichmaxerl[10][63][-144]};
