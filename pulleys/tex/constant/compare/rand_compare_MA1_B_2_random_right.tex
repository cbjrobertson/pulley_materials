	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[pattern=north west lines, pattern color=black] (4.9,12.5) rectangle (5.1,9.5);
				\draw[fill=black!50] (5,12.5) circle (0.1);
				\draw[fill=black!50] (5,9.5) circle (0.1);
				...
				\draw[pattern=north west lines, pattern color=black] (7.9,3.5) rectangle (8.1,0.5);
				\draw[fill=black!50] (8,3.5) circle (0.1);
				\draw[fill=black!50] (8,0.5) circle (0.1);
				
				\draw[line width=0.5mm](2.5,5) --  (3,5.5) -- (3.5,5);
				\draw[fill=black!50] (2, 5) rectangle (4, 3);
				
				\draw[line width = 0.5mm] (3,8) -- (10,8);
				\draw[line width = 0.5mm] (10,8) arc (270:360:1);
				\draw[line width = 0.5mm] (11,9) -- (11,12);
				\draw[line width = 0.5mm] (5,8) arc (270:360:1);
				
				\node at (5, 6) {\scriptsize \Strichmaxerl[10][-131][0]};
