	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw (3,9) circle (1);
				\draw[fill=black] (3,9) circle (0.1);
				\draw (-2,14.0) -- (3,9);
				...
				\draw[fill=black!50] (6,12) circle (0.1);
				\draw[line width=0.5mm](5.5,9.5) -- (6,12) --  (6.5,9.5);
				...
				\draw[line width = 0.5mm] (4,-1) -- (4,3);
				\centerarc[line width = 0.5mm](5,3)(0:180:1);
				\draw[line width = 0.5mm] (6,3) -- (6,2);
				\centerarc[line width = 0.5mm](7,2)(180:270:1);
				\draw[line width = 0.5mm] (7,1) -- (10,1);
				
				\node at (-1, 3) {\scriptsize \Strichmaxerl[10][-66][-62]};
