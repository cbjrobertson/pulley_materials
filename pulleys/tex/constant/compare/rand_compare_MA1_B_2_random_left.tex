	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[pattern=north west lines, pattern color=black] (7.9,13.5) rectangle (8.1,10.5);
				\draw[fill=black!50] (8,13.5) circle (0.1);
				\draw[fill=black!50] (8,10.5) circle (0.1);
				...
				\node at (6, 11) {\scriptsize \Strichmaxerl[10][-107][80]};
