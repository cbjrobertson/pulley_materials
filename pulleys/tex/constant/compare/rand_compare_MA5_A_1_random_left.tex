	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[pattern=north west lines, pattern color=black] (1.9,0.5) rectangle (2.1,-2.5);
				...
				\draw[pattern=north west lines, pattern color=black] (2.9,1.5) rectangle (3.1,-1.5);
				\draw[fill=black!50] (3,1.5) circle (0.1);
				\draw[fill=black!50] (3,-1.5) circle (0.1);
				
				\draw[fill=black!50] (7,6) circle (0.1);
				\draw[line width=0.5mm](6.5,5.5) -- (7,6) --  (7.5,5.5);
				\draw[line width=0.5mm](6,5) --  (6.5,5.5) -- (7,5) -- (7.5,5.5) -- (8,5);
				\draw[fill=black!50] (6, 5) rectangle (8, 3);
				...
				\node at (8, 10) {\scriptsize \Strichmaxerl[10][-143][170]};
