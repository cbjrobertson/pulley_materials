	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[line width=0.5mm](5.5,5) --  (6,5.5) -- (6.5,5);
				\draw[fill=black!50] (5, 5) rectangle (7, 3);
				
				\draw[line width = 0.5mm] (3,4) -- (10,4);
				\draw[line width = 0.5mm] (10,4) arc (270:360:1);
				\draw[line width = 0.5mm] (11,5) -- (11,12);
				...
				\node at (0, 6) {\scriptsize \Strichmaxerl[10][-174][128]};
