	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[pattern=north west lines, pattern color=black] (-0.1,11.5) rectangle (0.1,8.5);
				\draw[fill=black!50] (0,11.5) circle (0.1);
				...
				\draw[fill=black!50] (3,14) circle (0.1);
				\draw[line width=0.5mm](2.5,12.5) -- (3,14) --  (3.5,12.5);
				...
				\draw[line width = 0.5mm] (1,5) arc (270:360:1);
				
				\node at (2, 4) {\scriptsize \Strichmaxerl[10][80][39]};
