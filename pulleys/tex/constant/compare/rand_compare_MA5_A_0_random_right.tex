	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[pattern=north west lines, pattern color=black] (4.9,9.5) rectangle (5.1,6.5);
				...
				\draw[line width = 0.5mm] (4,9) -- (4,6);
				\centerarc[line width = 0.5mm](5,6)(270:180:1);
				
				\node at (5, 7) {\scriptsize \Strichmaxerl[10][143][159]};
