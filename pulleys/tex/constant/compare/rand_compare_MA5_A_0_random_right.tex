	...
	\begin{figure}[!htbp]
		...
		\begin{subfigure}[b]{0.48\textwidth}
			...
			\begin{tikzpicture}
				...
				\draw[line width=0.5mm](1,2.5) -- (1,11.0);
				\draw[line width=0.5mm](0.5,2) --  (1,2.5) -- (1.5,2);
				\draw[fill=black!50] (0, 2) rectangle (2, 0);
				
				\draw[line width = 0.5mm] (5,6) -- (5,13);
				\draw[line width = 0.5mm] (4,14) arc (90:0:1);
				\draw[line width = 0.5mm] (4,14) -- (2,12);
				
				\node at (7, 0) {\scriptsize \Strichmaxerl[10][64][-21]};
