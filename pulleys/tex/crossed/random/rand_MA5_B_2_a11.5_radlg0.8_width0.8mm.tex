...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!29](10, 7) -- (15, 7);
			
			\draw[line width=0.7mm, color=black!90] (7, 7) rectangle (6, -3);
			\draw [line width=0.2mm, color=black!53](6, 11) circle (2.2);
			\draw[line width=0.4mm, color=black!16] (7, 9) rectangle (5, 6);
			\draw[line width=0.6mm, color=black!97] (-8, 12) rectangle (-9, 9);
			
			\draw[line width=0.3mm, color=black!79] (6, 2) rectangle (8, 4);
			
			\draw[line width=0.5mm, color=black!84](-8, 2) -- (-16, 3);
			
			\draw[line width=0.5mm, color=black!43](5, 1) -- (8, 4);
