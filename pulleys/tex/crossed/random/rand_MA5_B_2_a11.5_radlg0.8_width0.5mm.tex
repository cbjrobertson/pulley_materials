...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.7mm, color=black!34](-7, 5) circle (0.7);
			
			\draw[line width=0.5mm, color=black!51](5, -1) -- (5, 4);
			\node[line width=0.4mm, color=black!72] at (-10, 8) {\Strichmaxerl[4][4][32]};
			\draw [line width=0.7mm, color=black!19](-10, 9) circle (2.2);
			
			\draw [line width=0.4mm, color=black!71](7, 8) circle (1.3);
			
			\node[line width=0.5mm, color=black!72] at (-11, 6) {\Strichmaxerl[4][90][35]};
			\node[line width=0.4mm, color=black!100] at (-14, 10) {\Strichmaxerl[7][68][56]};
