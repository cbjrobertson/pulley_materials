...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.6mm, color=black!77] (-2, 7) rectangle (-5, 3);
			
			\node[line width=0.4mm, color=black!86] at (16, 8) {\Strichmaxerl[5][57][58]};
			\node[line width=0.3mm, color=black!54] at (-5, 0) {\Strichmaxerl[6][58][26]};
