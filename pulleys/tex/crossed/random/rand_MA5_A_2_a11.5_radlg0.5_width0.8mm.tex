...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.5mm, color=black!11](-7, 3) circle (0.5);
			
			\draw[line width=0.5mm, color=black!21](13, 6) -- (20, 12);
			\draw [line width=0.3mm, color=black!55](-3, 0) circle (1.6);
			\draw[line width=0.5mm, color=black!14] (-3, 4) rectangle (-4, 4);
			\draw [line width=0.6mm, color=black!85](13, 10) circle (0.8);
			\draw[line width=0.6mm, color=black!88] (-3, 1) rectangle (-4, -2);
			\draw[line width=0.5mm, color=black!23](12, 0) -- (13, 3);
			\draw [line width=0.4mm, color=black!13](-4, 7) circle (1.2);
			\draw[line width=0.2mm, color=black!56] (-4, -2) rectangle (-5, 1);
			...
			\centerarc[line width=0.8mm](6.7, 9.775)(30:180:0.6);
			\draw[line width=0.8mm](7.216, 10.081) -- (8.728, 6.306);
			\centerarc[line width=0.8mm](8.2, 6.0)(160:211:-0.6);
			\draw[line width=0.8mm](8.7638, 5.7948) -- (7.672, -0.862);
			\centerarc[line width=0.8mm](8.2, -1.15)(150:280:0.6);
			\draw[line width=0.8mm](8.3042, -1.7409) -- (11, -1.8);
