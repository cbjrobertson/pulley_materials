...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.2mm, color=black!40](-5, 8) circle (1.9);
			
			\node[line width=0.7mm, color=black!44] at (-4, 2) {\Strichmaxerl[6][7][55]};
			\node[line width=0.2mm, color=black!72] at (-8, 3) {\Strichmaxerl[7][72][62]};
