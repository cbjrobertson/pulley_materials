...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.2mm, color=black!92](-5, 6) circle (0.4);
			
			\draw[line width=0.2mm, color=black!95] (-4, 4) rectangle (-6, 11);
			\draw[line width=0.7mm, color=black!28] (-3, 7) rectangle (-5, -1);
			\draw [line width=0.5mm, color=black!25](19, 7) circle (1.4);
			
			\draw[line width=0.2mm, color=black!38] (-3, 1) rectangle (-3, 14);
			\draw [line width=0.5mm, color=black!99](20, 6) circle (1.7);
			\draw[line width=0.3mm, color=black!10] (-4, 12) rectangle (-6, 10);
			\draw[line width=0.5mm, color=black!18](17, 1) -- (12, -2);
			\node[line width=0.2mm, color=black!52] at (19, 12) {\Strichmaxerl[5][77][20]};
			
			\draw[line width=0.5mm, color=black!31](-7, 4) -- (-7, 4);
