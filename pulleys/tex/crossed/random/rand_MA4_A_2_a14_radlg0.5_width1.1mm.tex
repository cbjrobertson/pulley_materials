...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!35](-5, -1) -- (-3, 12);
			
			\draw[line width=0.2mm, color=black!70] (13, 4) rectangle (12, 1);
			\node[line width=0.2mm, color=black!13] at (14, 4) {\Strichmaxerl[6][4][36]};
			\draw[line width=0.5mm, color=black!88](-6, 10) -- (-11, 10);
			\node[line width=0.4mm, color=black!28] at (-5, 11) {\Strichmaxerl[2][59][34]};
			\draw [line width=0.2mm, color=black!18](14, 10) circle (1.2);
			\draw[line width=0.5mm, color=black!34](-3, 9) -- (-7, 2);
			\node[line width=0.4mm, color=black!47] at (18, 6) {\Strichmaxerl[3][74][54]};
			\node[line width=0.7mm, color=black!31] at (14, 1) {\Strichmaxerl[5][68][61]};
			\draw[line width=0.5mm, color=black!17] (14, 7) rectangle (12, 1);
			
			\draw[line width=0.5mm, color=black!74](-6, 14) -- (-11, 3);
			\draw[line width=0.4mm, color=black!49] (12, 1) rectangle (13, 10);
