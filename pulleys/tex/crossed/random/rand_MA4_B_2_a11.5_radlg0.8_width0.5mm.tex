...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.3mm, color=black!19] (-5, 9) rectangle (-4, 9);
			
			\draw[line width=0.5mm, color=black!11](-6, 11) -- (-6, 2);
			\node[line width=0.2mm, color=black!49] at (-13, 4) {\Strichmaxerl[6][90][77]};
			\draw[line width=0.5mm, color=black!70](11, 0) -- (15, -3);
			
			\draw[line width=0.4mm, color=black!89] (6, 9) rectangle (8, -1);
			\draw [line width=0.7mm, color=black!51](14, 3) circle (1.3);
