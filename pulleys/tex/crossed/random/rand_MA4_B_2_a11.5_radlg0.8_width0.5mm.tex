...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.7mm, color=black!80] at (9, 5) {\Strichmaxerl[7][78][27]};
			
			\node[line width=0.6mm, color=black!30] at (-6, 2) {\Strichmaxerl[3][67][60]};
			\draw[line width=0.7mm, color=black!76] (8, 8) rectangle (6, 3);
			\draw[line width=0.5mm, color=black!67](-6, 8) -- (-7, 6);
			\draw[line width=0.2mm, color=black!81] (7, 1) rectangle (8, 5);
			\draw [line width=0.3mm, color=black!72](11, 6) circle (0.1);
			\draw [line width=0.7mm, color=black!19](7, 8) circle (1.4);
			
			\node[line width=0.4mm, color=black!18] at (6, 10) {\Strichmaxerl[4][49][61]};
			\node[line width=0.5mm, color=black!38] at (-8, 6) {\Strichmaxerl[2][48][11]};
			
			\draw[line width=0.5mm, color=black!96](7, 0) -- (15, -2);
			
			\draw[line width=0.3mm, color=black!83] (-5, -3) rectangle (-7, 1);
			\draw [line width=0.5mm, color=black!77](-7, 8) circle (0.1);
			\draw[line width=0.5mm, color=black!41](-7, 5) -- (-14, 5);
