...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.6mm, color=black!90] at (8, 0) {\Strichmaxerl[2][90][35]};
			
			\node[line width=0.3mm, color=black!49] at (-6, 5) {\Strichmaxerl[1][34][41]};
			\draw[line width=0.3mm, color=black!70] (7, 5) rectangle (8, 9);
			\draw[line width=0.5mm, color=black!57](7, 9) -- (15, 9);
			\node[line width=0.3mm, color=black!39] at (-10, 6) {\Strichmaxerl[4][17][27]};
			\draw[line width=0.5mm, color=black!88](10, 3) -- (14, 4);
			\node[line width=0.4mm, color=black!33] at (-4, 3) {\Strichmaxerl[4][39][49]};
			
			\node[line width=0.2mm, color=black!69] at (-9, 2) {\Strichmaxerl[3][77][22]};
			\draw[line width=0.7mm, color=black!30] (-4, -2) rectangle (-7, 7);
			
			\draw[line width=0.2mm, color=black!67] (7, 0) rectangle (6, 1);
			\draw [line width=0.2mm, color=black!68](-4, 6) circle (1.8);
