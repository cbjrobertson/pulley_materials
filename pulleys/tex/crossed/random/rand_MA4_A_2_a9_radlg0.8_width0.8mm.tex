...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!72] (-3, 1) rectangle (-5, -1);
			
			\node[line width=0.6mm, color=black!94] at (14, 4) {\Strichmaxerl[6][4][43]};
			\draw[line width=0.3mm, color=black!11] (-2, 1) rectangle (-2, 1);
			\node[line width=0.3mm, color=black!71] at (15, -2) {\Strichmaxerl[2][25][80]};
			
			\node[line width=0.2mm, color=black!85] at (-3, -3) {\Strichmaxerl[1][0][11]};
			\draw [line width=0.3mm, color=black!34](16, 2) circle (0.6);
			\draw[line width=0.5mm, color=black!53](-7, -3) -- (-9, -3);
			\draw [line width=0.2mm, color=black!55](15, 1) circle (0.2);
			\draw[line width=0.2mm, color=black!95] (13, 0) rectangle (15, 6);
			\draw[line width=0.5mm, color=black!44](15, 5) -- (14, 5);
