...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.2mm, color=black!91](13, 1) circle (0.4);
			
			\node[line width=0.2mm, color=black!61] at (15, 1) {\Strichmaxerl[5][26][39]};
			\draw[line width=0.5mm, color=black!68](-6, 9) -- (-9, 10);
