...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!38](16, 9) -- (15, 4);
			
			\draw[line width=0.5mm, color=black!40](16, 10) -- (15, 3);
			\draw[line width=0.6mm, color=black!16] (-3, -1) rectangle (-6, 11);
			\draw [line width=0.3mm, color=black!26](-3, 11) circle (2.4);
			\draw [line width=0.4mm, color=black!42](18, -2) circle (0.9);
			\draw[line width=0.5mm, color=black!25] (13, -1) rectangle (14, 10);
			\node[line width=0.7mm, color=black!10] at (-8, 14) {\Strichmaxerl[5][35][15]};
			
			\draw[line width=0.7mm, color=black!52] (14, 7) rectangle (16, 5);
			\draw [line width=0.2mm, color=black!32](-3, 4) circle (1.1);
			...
			\centerarc[line width=0.5mm](6.7, 11.9)(30:180:1.2000000000000002);
			\draw[line width=0.5mm](7.732, 12.512) -- (9.256, 6.612);
			\centerarc[line width=0.5mm](8.2, 6)(160:211:-1.2000000000000002);
			\draw[line width=0.5mm](9.3276, 5.5896) -- (7.144, -0.824);
			\centerarc[line width=0.5mm](8.2, -1.4)(150:280:1.2000000000000002);
			\draw[line width=0.5mm](8.4083, -2.5818) -- (11, -1.8);
