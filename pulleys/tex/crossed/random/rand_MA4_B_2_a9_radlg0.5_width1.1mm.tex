...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.7mm, color=black!65](-8, 1) circle (1.7);
			
			\draw [line width=0.7mm, color=black!26](9, 2) circle (1.4);
			\draw[line width=0.6mm, color=black!95] (-4, 1) rectangle (-8, 5);
			\draw[line width=0.7mm, color=black!77] (6, 2) rectangle (7, 2);
			\draw [line width=0.6mm, color=black!24](6, 5) circle (1.0);
			\node[line width=0.5mm, color=black!78] at (6, 1) {\Strichmaxerl[7][20][54]};
			
			\draw [line width=0.5mm, color=black!88](11, -1) circle (1.2);
			
			\draw [line width=0.5mm, color=black!39](-10, 5) circle (1.2);
			\draw[line width=0.5mm, color=black!38] (6, 8) rectangle (6, 3);
			\draw [line width=0.4mm, color=black!86](10, 2) circle (0.6);
			
			\draw [line width=0.5mm, color=black!34](8, 2) circle (0.4);
