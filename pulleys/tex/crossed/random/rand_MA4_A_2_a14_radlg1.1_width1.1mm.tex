...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.6mm, color=black!14](18, 2) circle (0.6);
			
			\draw[line width=0.5mm, color=black!56] (14, 1) rectangle (16, -1);
			\draw[line width=0.5mm, color=black!54](-4, 3) -- (-2, 10);
			\draw[line width=0.5mm, color=black!47](-6, 1) -- (-12, 14);
			\draw[line width=0.3mm, color=black!20] (12, 1) rectangle (15, -2);
			\node[line width=0.4mm, color=black!96] at (-11, 7) {\Strichmaxerl[7][49][52]};
			
			\draw[line width=0.4mm, color=black!36] (-3, 4) rectangle (-4, 3);
			\node[line width=0.2mm, color=black!57] at (14, 5) {\Strichmaxerl[1][76][25]};
			\node[line width=0.2mm, color=black!49] at (14, 3) {\Strichmaxerl[1][15][36]};
			\draw[line width=0.3mm, color=black!50] (12, 4) rectangle (14, 5);
			\draw[line width=0.6mm, color=black!53] (-2, 14) rectangle (-4, 14);
			
			\draw[line width=0.5mm, color=black!73](-2, 1) -- (-4, 11);
