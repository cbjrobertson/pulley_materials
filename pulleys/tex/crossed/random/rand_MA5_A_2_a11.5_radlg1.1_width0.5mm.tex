...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.6mm, color=black!16] at (15, 5) {\Strichmaxerl[2][20][8]};
			
			\draw [line width=0.5mm, color=black!58](-5, 12) circle (0.9);
			\node[line width=0.2mm, color=black!66] at (19, 5) {\Strichmaxerl[6][19][85]};
			\draw[line width=0.3mm, color=black!95] (-4, 5) rectangle (-2, 1);
			\draw[line width=0.2mm, color=black!62] (-4, 10) rectangle (-3, 2);
			\draw[line width=0.5mm, color=black!36](-5, 2) -- (-5, 12);
			
			\draw[line width=0.7mm, color=black!86] (12, -1) rectangle (14, 6);
			\draw [line width=0.3mm, color=black!43](-6, 1) circle (1.0);
			\draw [line width=0.5mm, color=black!36](17, 4) circle (0.8);
			\draw [line width=0.7mm, color=black!38](13, -3) circle (0.8);
