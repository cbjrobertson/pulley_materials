...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.2mm, color=black!73] (13, -2) rectangle (16, 8);
			
			\draw [line width=0.7mm, color=black!70](-10, 1) circle (1.6);
			\draw [line width=0.2mm, color=black!57](15, 8) circle (1.8);
			\draw [line width=0.6mm, color=black!57](-11, -2) circle (2.4);
			\node[line width=0.7mm, color=black!56] at (12, 1) {\Strichmaxerl[5][25][79]};
			\draw [line width=0.7mm, color=black!11](-4, 7) circle (0.9);
			\node[line width=0.4mm, color=black!29] at (-7, 3) {\Strichmaxerl[7][70][80]};
