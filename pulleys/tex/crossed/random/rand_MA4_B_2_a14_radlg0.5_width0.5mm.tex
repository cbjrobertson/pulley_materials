...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.6mm, color=black!59] at (10, 1) {\Strichmaxerl[2][29][72]};
			
			\node[line width=0.7mm, color=black!73] at (9, 12) {\Strichmaxerl[7][30][63]};
			\node[line width=0.6mm, color=black!50] at (9, 3) {\Strichmaxerl[6][73][61]};
			\draw [line width=0.3mm, color=black!90](12, -2) circle (1.0);
			\node[line width=0.6mm, color=black!74] at (-6, 13) {\Strichmaxerl[6][19][26]};
			\draw [line width=0.6mm, color=black!49](-6, 4) circle (1.2);
			\draw [line width=0.7mm, color=black!27](11, 12) circle (2.1);
			\draw[line width=0.7mm, color=black!58] (8, 6) rectangle (9, 4);
			\draw [line width=0.6mm, color=black!94](6, 2) circle (1.4);
