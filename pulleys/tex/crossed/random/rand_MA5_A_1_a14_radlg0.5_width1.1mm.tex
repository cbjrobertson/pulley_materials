...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!94](14, 9) -- (20, 14);
			
			\draw[line width=0.5mm, color=black!99](12, 2) -- (16, 4);
			\draw[line width=0.2mm, color=black!56] (-2, -1) rectangle (-5, 11);
			\draw[line width=0.5mm, color=black!38](-2, 6) -- (-5, 5);
			
			\draw [line width=0.6mm, color=black!66](-6, 6) circle (1.6);
			\draw[line width=0.4mm, color=black!43] (12, 3) rectangle (14, 6);
			\draw[line width=0.5mm, color=black!33](-6, 9) -- (-2, 9);
			\draw[line width=0.5mm, color=black!43](-2, 3) -- (-2, 2);
			\draw [line width=0.2mm, color=black!64](17, 13) circle (2.0);
			
			\draw [line width=0.7mm, color=black!69](15, 9) circle (0.0);
			\draw [line width=0.6mm, color=black!17](-3, 3) circle (0.7);
			\draw [line width=0.5mm, color=black!94](-6, 1) circle (0.6);
			\draw [line width=0.3mm, color=black!30](-7, 10) circle (0.2);
