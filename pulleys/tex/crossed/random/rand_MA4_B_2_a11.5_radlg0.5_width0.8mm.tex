...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.6mm, color=black!83] at (-7, 5) {\Strichmaxerl[3][26][15]};
			
			\draw[line width=0.5mm, color=black!70](7, 6) -- (9, -1);
			\draw[line width=0.5mm, color=black!80](10, 11) -- (13, -2);
			\draw[line width=0.5mm, color=black!17](9, -3) -- (11, 3);
			\draw[line width=0.5mm, color=black!71](-5, 7) -- (-11, -2);
			\draw [line width=0.3mm, color=black!95](13, 8) circle (2.0);
			\draw [line width=0.4mm, color=black!92](-7, -1) circle (1.5);
			
			\draw[line width=0.5mm, color=black!57](11, 9) -- (16, 9);
			\node[line width=0.7mm, color=black!69] at (9, 4) {\Strichmaxerl[1][16][0]};
