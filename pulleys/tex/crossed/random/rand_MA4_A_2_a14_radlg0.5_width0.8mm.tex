...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.3mm, color=black!47] (-3, 7) rectangle (-4, 13);
			
			\draw[line width=0.5mm, color=black!48](-7, 8) -- (-3, -1);
			\node[line width=0.7mm, color=black!43] at (-4, 6) {\Strichmaxerl[7][11][31]};
			\draw [line width=0.5mm, color=black!94](-3, 11) circle (2.0);
			\draw [line width=0.2mm, color=black!96](-2, 1) circle (1.4);
			\draw[line width=0.5mm, color=black!51] (13, -1) rectangle (12, 3);
			\draw[line width=0.5mm, color=black!51](12, 7) -- (21, 10);
			\node[line width=0.5mm, color=black!91] at (-4, 2) {\Strichmaxerl[6][7][51]};
			\draw[line width=0.5mm, color=black!61](16, 2) -- (21, 11);
			
			\draw [line width=0.3mm, color=black!11](12, 9) circle (0.9);
			\draw[line width=0.5mm, color=black!14](-3, -1) -- (-11, 9);
			
			\draw [line width=0.2mm, color=black!99](-3, 0) circle (1.7);
			\node[line width=0.6mm, color=black!57] at (-5, 6) {\Strichmaxerl[1][25][31]};
