...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!23](12, 11) -- (21, 9);
			
			\node[line width=0.4mm, color=black!58] at (-9, -1) {\Strichmaxerl[4][35][73]};
			\node[line width=0.5mm, color=black!66] at (20, 3) {\Strichmaxerl[2][87][43]};
			\node[line width=0.3mm, color=black!25] at (17, -3) {\Strichmaxerl[1][37][10]};
