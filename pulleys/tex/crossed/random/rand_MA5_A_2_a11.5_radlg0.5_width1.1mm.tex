...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!88](-3, 9) -- (-5, 7);
			
			\draw [line width=0.7mm, color=black!75](14, 9) circle (0.6);
			\draw [line width=0.2mm, color=black!61](15, 9) circle (0.8);
			\draw[line width=0.7mm, color=black!54] (-4, 0) rectangle (-6, 10);
			\node[line width=0.6mm, color=black!52] at (13, 3) {\Strichmaxerl[6][32][11]};
			
			\node[line width=0.3mm, color=black!46] at (-7, 5) {\Strichmaxerl[7][45][63]};
			
			\draw[line width=0.5mm, color=black!52](-7, 9) -- (-6, 2);
			\draw[line width=0.5mm, color=black!74](-5, 9) -- (-9, 8);
