...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.7mm, color=black!75] at (-7, 9) {\Strichmaxerl[4][17][44]};
			
			\draw[line width=0.7mm, color=black!50] (6, 10) rectangle (9, 0);
			\node[line width=0.5mm, color=black!95] at (-8, 2) {\Strichmaxerl[7][0][63]};
			\draw[line width=0.5mm, color=black!78](-5, -2) -- (-6, 3);
			
			\draw[line width=0.5mm, color=black!78](6, 4) -- (10, 10);
			\draw[line width=0.2mm, color=black!13] (-5, 10) rectangle (-7, 4);
			\draw[line width=0.5mm, color=black!42](-3, 10) -- (-6, 6);
			
			\draw[line width=0.5mm, color=black!100](-8, 12) -- (-4, 3);
			\node[line width=0.5mm, color=black!28] at (-6, -2) {\Strichmaxerl[7][67][44]};
			\node[line width=0.7mm, color=black!17] at (10, 6) {\Strichmaxerl[1][20][20]};
			\draw [line width=0.2mm, color=black!56](-4, 6) circle (0.3);
			\draw[line width=0.3mm, color=black!38] (-5, 9) rectangle (-4, 4);
