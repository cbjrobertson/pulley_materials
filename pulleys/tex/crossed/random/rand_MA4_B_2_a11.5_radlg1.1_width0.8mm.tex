...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.6mm, color=black!81] (-4, 9) rectangle (-6, 0);
			
			\draw[line width=0.5mm, color=black!72](9, 5) -- (9, 1);
			\draw[line width=0.6mm, color=black!38] (-5, -1) rectangle (-4, 12);
			\node[line width=0.5mm, color=black!30] at (-10, 5) {\Strichmaxerl[5][49][19]};
			
			\draw [line width=0.4mm, color=black!90](9, 6) circle (0.1);
			\draw[line width=0.5mm, color=black!20](-7, 10) -- (-5, 11);
			
			\draw [line width=0.7mm, color=black!85](-7, 2) circle (2.0);
			\node[line width=0.6mm, color=black!79] at (-6, 6) {\Strichmaxerl[7][65][35]};
			\draw[line width=0.7mm, color=black!79] (-4, 9) rectangle (-8, 11);
			
			\draw[line width=0.5mm, color=black!52](-7, 7) -- (-6, 5);
			\draw[line width=0.5mm, color=black!43](-5, 2) -- (-11, 8);
