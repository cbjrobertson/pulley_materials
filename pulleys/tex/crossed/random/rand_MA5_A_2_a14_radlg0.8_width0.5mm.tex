...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.2mm, color=black!38](20, 10) circle (0.9);
			
			\draw [line width=0.2mm, color=black!76](13, 11) circle (1.7);
			\draw[line width=0.6mm, color=black!57] (12, 3) rectangle (13, -2);
			\draw[line width=0.4mm, color=black!71] (-2, 12) rectangle (-4, 6);
			\node[line width=0.4mm, color=black!60] at (18, 5) {\Strichmaxerl[1][48][29]};
			...
			\centerarc[line width=0.5mm](6.7, 11.9)(30:180:0.9);
			\draw[line width=0.5mm](7.474, 12.359) -- (8.992, 6.459);
			\centerarc[line width=0.5mm](8.2, 6)(160:211:-0.9);
			\draw[line width=0.5mm](9.0457, 5.6922) -- (7.408, -0.968);
			\centerarc[line width=0.5mm](8.2, -1.4)(150:280:0.9);
			\draw[line width=0.5mm](8.3562, -2.2863) -- (11, -1.8);
