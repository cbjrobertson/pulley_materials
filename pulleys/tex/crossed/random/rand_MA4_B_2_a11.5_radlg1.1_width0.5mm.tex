...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.6mm, color=black!46](11, -2) circle (2.3);
			
			\draw[line width=0.5mm, color=black!88](8, 5) -- (9, -3);
			\node[line width=0.2mm, color=black!42] at (-7, 3) {\Strichmaxerl[2][34][79]};
			\draw[line width=0.5mm, color=black!89](-4, -3) -- (-7, 10);
			\draw[line width=0.5mm, color=black!35](-9, 3) -- (-6, 8);
			\node[line width=0.3mm, color=black!81] at (-6, 11) {\Strichmaxerl[4][24][47]};
