...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.3mm, color=black!11](-6, -1) circle (1.4);
			
			\draw[line width=0.5mm, color=black!21](9, 0) -- (10, -3);
			\node[line width=0.7mm, color=black!15] at (10, 11) {\Strichmaxerl[2][45][66]};
			\draw[line width=0.5mm, color=black!46] (8, 11) rectangle (7, -3);
			
			\draw[line width=0.5mm, color=black!97](-6, 0) -- (-7, 10);
			\draw[line width=0.6mm, color=black!94] (-5, 10) rectangle (-4, 6);
			
			\draw[line width=0.5mm, color=black!64](-4, 10) -- (-13, 9);
			\draw[line width=0.5mm, color=black!84](-5, 10) -- (-6, 2);
