...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.4mm, color=black!11](-4, 4) circle (1.9);
			
			\draw[line width=0.5mm, color=black!36](16, 5) -- (14, 3);
			\draw[line width=0.4mm, color=black!74] (-3, 11) rectangle (-6, 9);
			\draw[line width=0.5mm, color=black!61](16, -1) -- (16, 9);
			
			\draw[line width=0.7mm, color=black!17] (-4, 10) rectangle (-2, -3);
			\draw[line width=0.5mm, color=black!33](-6, 1) -- (-7, -2);
			\draw[line width=0.5mm, color=black!85](16, 6) -- (18, 9);
			\draw [line width=0.3mm, color=black!61](-8, 3) circle (2.0);
			\node[line width=0.3mm, color=black!40] at (19, 8) {\Strichmaxerl[1][45][40]};
			\draw[line width=0.5mm, color=black!31] (13, 5) rectangle (14, -2);
			\draw[line width=0.5mm, color=black!46](12, 12) -- (13, 12);
			\node[line width=0.5mm, color=black!13] at (18, 7) {\Strichmaxerl[5][76][17]};
			\draw[line width=0.7mm, color=black!64] (13, -2) rectangle (14, 4);
			
			\draw [line width=0.4mm, color=black!47](-4, 7) circle (0.2);
