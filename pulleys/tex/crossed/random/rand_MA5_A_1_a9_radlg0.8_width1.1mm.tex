...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!96](-3, 1) -- (-9, 7);
			
			\draw [line width=0.2mm, color=black!31](15, 3) circle (2.4);
			\draw [line width=0.7mm, color=black!65](-5, -2) circle (1.5);
			\draw [line width=0.2mm, color=black!14](13, 4) circle (1.6);
			\draw[line width=0.5mm, color=black!63](-5, 7) -- (-7, 0);
			\node[line width=0.6mm, color=black!87] at (20, 6) {\Strichmaxerl[1][56][74]};
			\draw [line width=0.6mm, color=black!56](14, 4) circle (2.0);
			\draw[line width=0.6mm, color=black!28] (-2, 2) rectangle (-5, 9);
			\draw[line width=0.7mm, color=black!13] (-3, -3) rectangle (-5, 1);
