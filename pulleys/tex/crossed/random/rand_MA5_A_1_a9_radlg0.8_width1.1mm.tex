...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.6mm, color=black!21] (-2, 6) rectangle (-2, 2);
			
			\node[line width=0.3mm, color=black!83] at (12, 0) {\Strichmaxerl[6][15][51]};
			\draw [line width=0.5mm, color=black!40](14, 2) circle (0.7);
			\draw[line width=0.5mm, color=black!46](17, -1) -- (16, 8);
			\node[line width=0.7mm, color=black!82] at (19, 3) {\Strichmaxerl[1][0][5]};
			
			\draw [line width=0.3mm, color=black!37](16, 5) circle (1.7);
			
			\draw[line width=0.5mm, color=black!17](16, 1) -- (22, 0);
			\draw[line width=0.7mm, color=black!77] (-3, -3) rectangle (-5, 3);
			\draw[line width=0.5mm, color=black!83](-7, 7) -- (-10, 7);
			\node[line width=0.7mm, color=black!74] at (20, 5) {\Strichmaxerl[1][27][12]};
