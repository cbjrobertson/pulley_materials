...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.3mm, color=black!34] at (18, 0) {\Strichmaxerl[1][23][16]};
			
			\draw [line width=0.6mm, color=black!83](19, 2) circle (2.4);
			\draw[line width=0.7mm, color=black!39] (12, 5) rectangle (16, 2);
			\node[line width=0.4mm, color=black!14] at (19, 4) {\Strichmaxerl[1][83][89]};
			
			\draw [line width=0.6mm, color=black!23](-4, 7) circle (1.5);
			\draw[line width=0.5mm, color=black!89](13, 3) -- (16, 12);
			
			\draw[line width=0.5mm, color=black!66](-3, -1) -- (-8, 2);
			
			\draw [line width=0.5mm, color=black!26](19, 10) circle (0.0);
			\draw[line width=0.7mm, color=black!18] (12, 12) rectangle (16, 9);
