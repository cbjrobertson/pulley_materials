...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.2mm, color=black!87] (13, 4) rectangle (14, 2);
			
			\draw[line width=0.5mm, color=black!78](15, 5) -- (16, -2);
			\draw[line width=0.6mm, color=black!40] (-3, 6) rectangle (-5, 9);
			\draw [line width=0.6mm, color=black!51](-6, 7) circle (0.2);
			\draw[line width=0.5mm, color=black!92] (14, 6) rectangle (13, 1);
			\draw[line width=0.5mm, color=black!32](-2, 2) -- (-11, 0);
			
			\draw[line width=0.3mm, color=black!61] (-4, 1) rectangle (-3, 1);
			\node[line width=0.7mm, color=black!92] at (14, 2) {\Strichmaxerl[6][32][38]};
			\draw[line width=0.5mm, color=black!85](13, 1) -- (16, 6);
			...
			\centerarc[line width=1.1mm](6.7, 7.65)(30:180:0.9);
			\draw[line width=1.1mm](7.474, 8.109) -- (8.992, 6.459);
			\centerarc[line width=1.1mm](8.2, 6)(160:211:-0.9);
			\draw[line width=1.1mm](9.0457, 5.6922) -- (7.408, -0.468);
			\centerarc[line width=1.1mm](8.2, -0.9)(150:280:0.9);
			\draw[line width=1.1mm](8.3562, -1.7863) -- (11, -1.8);
