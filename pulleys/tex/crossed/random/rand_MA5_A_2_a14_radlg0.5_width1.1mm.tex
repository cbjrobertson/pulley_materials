...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\centerarc[line width=1.1mm](6.7, 11.9)(30:180:0.6);
			\draw[line width=1.1mm](7.216, 12.206) -- (8.728, 6.306);
			\centerarc[line width=1.1mm](8.2, 6)(160:211:-0.6);
			\draw[line width=1.1mm](8.7638, 5.7948) -- (7.672, -1.112);
			\centerarc[line width=1.1mm](8.2, -1.4)(150:280:0.6);
			\draw[line width=1.1mm](8.3042, -1.9909) -- (11, -1.8);
			
			\draw[line width=0.5mm, color=black!10](-6, 4) -- (-11, 7);
			
			\node[line width=0.2mm, color=black!63] at (-4, 13) {\Strichmaxerl[7][83][30]};
			\draw[line width=0.6mm, color=black!62] (13, 5) rectangle (12, 7);
			\draw[line width=0.5mm, color=black!77](-4, 8) -- (-3, 6);
			\node[line width=0.7mm, color=black!47] at (16, 6) {\Strichmaxerl[6][70][14]};
			\draw[line width=0.4mm, color=black!66] (-2, 1) rectangle (-4, 0);
			\draw[line width=0.5mm, color=black!76](15, 0) -- (16, 1);
			
			\draw [line width=0.2mm, color=black!35](-3, -2) circle (1.2);
			\draw [line width=0.7mm, color=black!28](-6, 8) circle (0.8);
			
			\draw[line width=0.5mm, color=black!79](-7, 6) -- (-10, 7);
