...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!13](17, 14) -- (14, 12);
			
			\draw[line width=0.5mm, color=black!27](15, 6) -- (18, 2);
			\draw[line width=0.7mm, color=black!67] (13, 10) rectangle (13, 10);
			\draw [line width=0.7mm, color=black!93](18, 5) circle (1.3);
