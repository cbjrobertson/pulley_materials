...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.4mm, color=black!53] at (-11, 6) {\Strichmaxerl[1][30][6]};
			
			\draw[line width=0.5mm, color=black!89](12, 8) -- (21, 10);
			\draw[line width=0.5mm, color=black!88](12, 2) -- (12, 13);
			\node[line width=0.6mm, color=black!48] at (18, 2) {\Strichmaxerl[6][88][27]};
			
			\draw [line width=0.6mm, color=black!77](-8, 9) circle (1.9);
