...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\centerarc[line width=0.8mm](6.7, 11.9)(0:180:1.2000000000000002);
			\draw[line width=0.8mm](7.9, 11.9) --  (7.0, 2);
			\centerarc[line width=0.8mm](8.2, 2)(180:220:1.2000000000000002);
			\draw[line width=0.8mm](7.2808, 1.2286) -- (11, -2);
			
			\node at (11.3, -2) {\Strichmaxerl[10][-35][-50]};
			
			\draw[line width=0.5mm, color=black!99](-5, 14) -- (-4, 7);
			
			\node[line width=0.4mm, color=black!65] at (-4, 3) {\Strichmaxerl[3][11][58]};
			\draw [line width=0.2mm, color=black!83](18, 7) circle (1.8);
			\draw [line width=0.4mm, color=black!99](-2, 1) circle (0.2);
			
			\draw[line width=0.3mm, color=black!42] (12, 5) rectangle (15, 4);
			\draw[line width=0.5mm, color=black!60] (-2, 12) rectangle (-4, 2);
			
			\draw [line width=0.2mm, color=black!90](15, -2) circle (1.0);
			\draw [line width=0.7mm, color=black!92](-5, 0) circle (0.1);
			\draw[line width=0.4mm, color=black!64] (-2, 0) rectangle (-3, 1);
			\draw[line width=0.4mm, color=black!20] (-2, 0) rectangle (-5, 0);
