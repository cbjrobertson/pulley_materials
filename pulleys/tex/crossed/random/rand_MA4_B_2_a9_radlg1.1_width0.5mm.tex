...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.5mm, color=black!79] at (-4, 2) {\Strichmaxerl[4][24][77]};
			
			\draw [line width=0.6mm, color=black!100](7, 7) circle (1.1);
			\draw [line width=0.7mm, color=black!33](11, 0) circle (1.4);
			\draw[line width=0.6mm, color=black!69] (8, 2) rectangle (8, 5);
			\draw [line width=0.5mm, color=black!45](-4, 3) circle (1.5);
			
			\draw[line width=0.5mm, color=black!27](11, 4) -- (16, 8);
			\draw[line width=0.5mm, color=black!43](8, 1) -- (12, 3);
			\draw[line width=0.5mm, color=black!81](8, 8) -- (8, 3);
			\node[line width=0.6mm, color=black!28] at (-13, 1) {\Strichmaxerl[1][70][32]};
			
			\draw[line width=0.5mm, color=black!66](8, 4) -- (10, 4);
