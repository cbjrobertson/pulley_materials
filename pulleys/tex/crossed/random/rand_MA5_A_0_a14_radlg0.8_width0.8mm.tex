...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.4mm, color=black!97](14, 5) circle (0.4);
			
			\draw [line width=0.3mm, color=black!99](-7, -1) circle (0.5);
			\draw [line width=0.6mm, color=black!19](-2, 3) circle (2.0);
			\draw[line width=0.5mm, color=black!31] (-2, 6) rectangle (-4, -3);
			
			\node[line width=0.2mm, color=black!50] at (-9, 0) {\Strichmaxerl[4][61][67]};
			\draw[line width=0.4mm, color=black!43] (-4, 6) rectangle (-2, 6);
			
			\draw[line width=0.5mm, color=black!56](-6, 2) -- (-7, 2);
			
			\draw [line width=0.2mm, color=black!56](18, 4) circle (1.1);
			\draw[line width=0.5mm, color=black!66](-5, 3) -- (-5, -1);
			
			\draw[line width=0.4mm, color=black!31] (-4, 10) rectangle (-5, 1);
			
			\draw[line width=0.5mm, color=black!29](-2, 10) -- (-12, 10);
			\draw[line width=0.4mm, color=black!42] (-4, 12) rectangle (-4, -2);
			\draw [line width=0.5mm, color=black!63](18, -2) circle (0.4);
