...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!41](12, 12) -- (12, 6);
			
			\draw [line width=0.7mm, color=black!29](-8, 3) circle (1.9);
			\node[line width=0.2mm, color=black!77] at (14, 5) {\Strichmaxerl[7][23][12]};
			\draw[line width=0.6mm, color=black!57] (14, -1) rectangle (16, 0);
			\draw [line width=0.3mm, color=black!56](-5, -3) circle (1.7);
			\draw[line width=0.2mm, color=black!56] (-4, 1) rectangle (-6, 4);
			
			\node[line width=0.3mm, color=black!19] at (12, 4) {\Strichmaxerl[6][71][6]};
			
			\node[line width=0.6mm, color=black!50] at (19, 5) {\Strichmaxerl[4][24][54]};
			\draw[line width=0.5mm, color=black!22](16, 3) -- (12, 2);
