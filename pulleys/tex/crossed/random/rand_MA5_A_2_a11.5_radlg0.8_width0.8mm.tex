...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.5mm, color=black!61](17, 5) circle (2.2);
			
			\draw[line width=0.5mm, color=black!71](14, -1) -- (21, -3);
			\draw[line width=0.5mm, color=black!90](15, 9) -- (14, 10);
			\node[line width=0.3mm, color=black!77] at (16, 5) {\Strichmaxerl[6][11][26]};
			\draw [line width=0.5mm, color=black!97](19, 1) circle (2.2);
			
			\draw[line width=0.5mm, color=black!19](12, 5) -- (14, 10);
			
			\node[line width=0.3mm, color=black!21] at (-5, 1) {\Strichmaxerl[1][42][38]};
			
			\draw[line width=0.5mm, color=black!67](-4, 8) -- (-3, 12);
			\node[line width=0.7mm, color=black!29] at (-5, 0) {\Strichmaxerl[3][68][6]};
			
			
			\draw (8.2, 6.0) circle (0.8);
			...
			\centerarc[line width=0.8mm](6.7, 9.775)(30:180:0.9);
			\draw[line width=0.8mm](7.474, 10.234) -- (8.992, 6.459);
			\centerarc[line width=0.8mm](8.2, 6.0)(160:211:-0.9);
			\draw[line width=0.8mm](9.0457, 5.6922) -- (7.408, -0.718);
			\centerarc[line width=0.8mm](8.2, -1.15)(150:280:0.9);
			\draw[line width=0.8mm](8.3562, -2.0363) -- (11, -1.8);
