...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.3mm, color=black!11](-7, 5) circle (0.9);
			
			\node[line width=0.3mm, color=black!28] at (18, 9) {\Strichmaxerl[4][33][43]};
			\draw [line width=0.4mm, color=black!27](-6, 3) circle (1.7);
