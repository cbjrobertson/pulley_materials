...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!21](15, 8) -- (21, 8);
			
			\draw [line width=0.6mm, color=black!27](-4, 9) circle (0.7);
			\draw[line width=0.5mm, color=black!67](14, 4) -- (12, 1);
			\node[line width=0.2mm, color=black!15] at (18, -1) {\Strichmaxerl[6][49][15]};
