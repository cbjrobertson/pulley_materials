...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!37](14, 14) -- (20, 7);
			
			\draw[line width=0.5mm, color=black!51](-5, 4) -- (-12, 13);
			\draw[line width=0.3mm, color=black!35] (13, 6) rectangle (12, 5);
			\draw[line width=0.5mm, color=black!31](-2, -1) -- (-2, 4);
			\node[line width=0.3mm, color=black!55] at (16, 3) {\Strichmaxerl[5][1][65]};
			
			\node[line width=0.7mm, color=black!28] at (-4, 6) {\Strichmaxerl[1][12][21]};
