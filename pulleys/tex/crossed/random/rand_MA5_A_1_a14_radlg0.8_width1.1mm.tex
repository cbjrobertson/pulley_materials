...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\centerarc[line width=1.1mm](6.7, 11.9)(0:180:0.9);
			\draw[line width=1.1mm](7.6, 11.9) --  (7.3, 2);
			\centerarc[line width=1.1mm](8.2, 2)(180:220:0.9);
			\draw[line width=1.1mm](7.5106, 1.4215) -- (11, -2);
			
			\node at (11.3, -2) {\Strichmaxerl[10][-35][-50]};
			
			\draw[line width=0.5mm, color=black!16](-4, 14) -- (-2, 4);
			
			\draw[line width=0.5mm, color=black!98](-6, -1) -- (-2, -3);
			\draw [line width=0.6mm, color=black!31](-7, 12) circle (0.1);
			\draw[line width=0.3mm, color=black!12] (12, 14) rectangle (16, 5);
			\node[line width=0.2mm, color=black!30] at (14, 8) {\Strichmaxerl[6][10][21]};
			\draw[line width=0.5mm, color=black!40](-4, 4) -- (-5, 2);
			\draw [line width=0.3mm, color=black!75](15, -2) circle (1.6);
			\node[line width=0.3mm, color=black!26] at (15, 9) {\Strichmaxerl[6][36][14]};
			\node[line width=0.7mm, color=black!60] at (-3, 8) {\Strichmaxerl[4][55][26]};
			\draw[line width=0.6mm, color=black!22] (-2, -1) rectangle (-3, 14);
			\draw[line width=0.4mm, color=black!92] (-4, 11) rectangle (-5, 14);
			
			\draw[line width=0.6mm, color=black!45] (-3, -3) rectangle (-2, 3);
