...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!22](-9, 1) -- (-12, 2);
			
			\draw[line width=0.5mm, color=black!68] (-7, 3) rectangle (-10, -2);
			\draw[line width=0.5mm, color=black!16] (-7, 10) rectangle (-6, -1);
			\draw[line width=0.5mm, color=black!54](-9, 9) -- (-13, 2);
			
			\draw[line width=0.5mm, color=black!21](-8, 3) -- (-8, 1);
			\draw [line width=0.2mm, color=black!21](12, 4) circle (2.4);
			
			\draw [line width=0.6mm, color=black!87](-10, 12) circle (1.4);
			\node[line width=0.6mm, color=black!70] at (-10, 9) {\Strichmaxerl[7][20][28]};
			\draw[line width=0.5mm, color=black!61](5, 12) -- (10, 7);
			
			\draw [line width=0.7mm, color=black!50](8, 8) circle (1.8);
			
			\draw[line width=0.4mm, color=black!28] (-8, 1) rectangle (-7, -1);
			
			\node[line width=0.2mm, color=black!26] at (6, -1) {\Strichmaxerl[2][57][41]};
			\draw[line width=0.5mm, color=black!45](-10, 8) -- (-7, 8);
			
			\draw[line width=0.3mm, color=black!35] (-7, -3) rectangle (-9, 0);
			\node[line width=0.2mm, color=black!33] at (5, 9) {\Strichmaxerl[2][12][29]};
			\node[line width=0.6mm, color=black!13] at (-10, -1) {\Strichmaxerl[3][41][51]};
