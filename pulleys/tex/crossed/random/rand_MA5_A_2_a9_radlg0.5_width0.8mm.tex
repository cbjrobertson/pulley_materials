...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!84](12, 7) -- (18, -3);
			
			\draw[line width=0.7mm, color=black!85] (-3, 4) rectangle (-3, 2);
			\draw [line width=0.3mm, color=black!81](14, -2) circle (1.8);
			\draw[line width=0.5mm, color=black!56](-2, 3) -- (-9, -1);
			\draw [line width=0.7mm, color=black!17](12, -2) circle (0.6);
			...
			\centerarc[line width=0.8mm](6.7, 7.65)(30:180:0.6);
			\draw[line width=0.8mm](7.216, 7.956) -- (8.728, 6.306);
			\centerarc[line width=0.8mm](8.2, 6)(160:211:-0.6);
			\draw[line width=0.8mm](8.7638, 5.7948) -- (7.672, -0.612);
			\centerarc[line width=0.8mm](8.2, -0.9)(150:280:0.6);
			\draw[line width=0.8mm](8.3042, -1.4909) -- (11, -1.8);
