...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.4mm, color=black!39] at (-4, 4) {\Strichmaxerl[3][41][72]};
			
			\draw[line width=0.6mm, color=black!27] (-3, 4) rectangle (-5, -3);
			\draw[line width=0.7mm, color=black!21] (13, 9) rectangle (14, 2);
			\draw[line width=0.4mm, color=black!35] (-4, 0) rectangle (-6, 1);
			\draw [line width=0.2mm, color=black!51](12, 5) circle (1.8);
			\node[line width=0.7mm, color=black!69] at (13, 6) {\Strichmaxerl[4][32][10]};
			\node[line width=0.5mm, color=black!42] at (-10, -3) {\Strichmaxerl[6][60][48]};
			\draw[line width=0.5mm, color=black!85](13, 1) -- (15, 4);
			\node[line width=0.3mm, color=black!28] at (-4, 0) {\Strichmaxerl[1][81][24]};
			
			\draw [line width=0.6mm, color=black!12](19, 3) circle (0.7);
			
			\draw[line width=0.5mm, color=black!99](-5, 4) -- (-3, -2);
			
			\draw[line width=0.5mm, color=black!83](-5, 5) -- (-7, 5);
			\node[line width=0.7mm, color=black!58] at (13, 4) {\Strichmaxerl[1][4][48]};
			\draw[line width=0.6mm, color=black!53] (14, -3) rectangle (14, -3);
			...
			\centerarc[line width=0.8mm](6.7, 7.65)(0:180:0.9);
			\draw[line width=0.8mm](7.6, 7.65) --  (7.3, 2);
