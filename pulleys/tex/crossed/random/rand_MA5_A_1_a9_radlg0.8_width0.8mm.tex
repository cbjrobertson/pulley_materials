...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!34] (13, 9) rectangle (13, -3);
			
			\draw[line width=0.5mm, color=black!59](-6, 9) -- (-7, 9);
			\draw[line width=0.2mm, color=black!79] (12, -3) rectangle (14, 6);
			\draw [line width=0.4mm, color=black!10](-5, 3) circle (0.1);
			
			\draw[line width=0.4mm, color=black!14] (-4, 8) rectangle (-5, 2);
			\draw[line width=0.5mm, color=black!98](-3, 4) -- (-4, 7);
			
			\node[line width=0.2mm, color=black!94] at (-10, -1) {\Strichmaxerl[3][14][85]};
			
			\draw[line width=0.5mm, color=black!53](17, 0) -- (19, 0);
			\draw [line width=0.7mm, color=black!99](19, 7) circle (0.6);
