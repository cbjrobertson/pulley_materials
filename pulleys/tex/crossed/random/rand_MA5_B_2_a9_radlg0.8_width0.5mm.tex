...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.2mm, color=black!15] (-6, 2) rectangle (-10, 0);
			
			\draw[line width=0.5mm, color=black!83](5, 9) -- (8, -1);
			\draw [line width=0.4mm, color=black!93](-8, 7) circle (2.0);
			\draw[line width=0.5mm, color=black!24](-7, 1) -- (-16, 6);
			\draw[line width=0.3mm, color=black!87] (5, 1) rectangle (7, -1);
			
			\node[line width=0.5mm, color=black!69] at (14, 2) {\Strichmaxerl[5][79][43]};
			
			\node[line width=0.3mm, color=black!39] at (5, 5) {\Strichmaxerl[7][28][21]};
			
			\draw[line width=0.5mm, color=black!38](9, 5) -- (14, 8);
			\draw [line width=0.7mm, color=black!82](7, 6) circle (1.4);
			
			\node[line width=0.4mm, color=black!68] at (-13, 3) {\Strichmaxerl[5][6][76]};
			
			\draw[line width=0.5mm, color=black!95](5, 8) -- (10, 6);
			
			\draw[line width=0.3mm, color=black!58] (7, -1) rectangle (8, 0);
			\draw[line width=0.5mm, color=black!27](-8, 4) -- (-16, 9);
			
			\draw [line width=0.5mm, color=black!77](-11, 1) circle (1.4);
			\draw[line width=0.4mm, color=black!87] (-6, -1) rectangle (-8, -2);
