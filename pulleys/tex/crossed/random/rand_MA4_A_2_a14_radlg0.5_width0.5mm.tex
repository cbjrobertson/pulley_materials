...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!44](-4, 4) -- (-3, -1);
			
			\draw[line width=0.5mm, color=black!38](13, 14) -- (21, 10);
			\draw [line width=0.7mm, color=black!46](17, 4) circle (1.9);
			\node[line width=0.3mm, color=black!78] at (20, 4) {\Strichmaxerl[7][45][74]};
			\draw [line width=0.4mm, color=black!33](-7, -1) circle (2.2);
			\node[line width=0.4mm, color=black!47] at (-5, 7) {\Strichmaxerl[4][28][14]};
			\node[line width=0.4mm, color=black!79] at (15, 0) {\Strichmaxerl[5][42][49]};
			\draw[line width=0.5mm, color=black!65] (-2, 4) rectangle (-2, 0);
			\node[line width=0.2mm, color=black!93] at (15, 0) {\Strichmaxerl[2][14][81]};
