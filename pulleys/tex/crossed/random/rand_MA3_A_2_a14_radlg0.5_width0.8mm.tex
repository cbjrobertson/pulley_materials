...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.5mm, color=black!83] at (14, 4) {\Strichmaxerl[7][59][75]};
			
			\draw[line width=0.6mm, color=black!72] (14, 10) rectangle (13, 2);
			\draw [line width=0.5mm, color=black!71](13, 1) circle (0.2);
			\draw[line width=0.2mm, color=black!78] (-4, 12) rectangle (-2, -3);
			
			\node[line width=0.2mm, color=black!31] at (-6, 12) {\Strichmaxerl[2][70][10]};
			\node[line width=0.7mm, color=black!25] at (22, 5) {\Strichmaxerl[2][53][87]};
			
			\draw[line width=0.5mm, color=black!56](16, -2) -- (17, 1);
			\draw[line width=0.5mm, color=black!27] (14, 12) rectangle (14, 14);
			\draw[line width=0.7mm, color=black!78] (12, 6) rectangle (16, -1);
			\node[line width=0.3mm, color=black!91] at (-9, 0) {\Strichmaxerl[4][88][37]};
			\draw[line width=0.5mm, color=black!53](-3, -3) -- (-4, 3);
			\draw[line width=0.5mm, color=black!21](15, -1) -- (20, -2);
			\draw [line width=0.7mm, color=black!46](14, 1) circle (0.3);
