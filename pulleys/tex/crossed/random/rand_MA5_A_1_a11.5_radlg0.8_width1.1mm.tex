...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.7mm, color=black!44](14, 2) circle (0.8);
			
			\node[line width=0.4mm, color=black!66] at (-4, 2) {\Strichmaxerl[6][28][31]};
			\draw[line width=0.5mm, color=black!38](-3, 1) -- (-5, 3);
			\node[line width=0.3mm, color=black!33] at (15, 1) {\Strichmaxerl[1][76][41]};
			
			\draw[line width=0.5mm, color=black!44](-6, 2) -- (-12, 3);
			\node[line width=0.4mm, color=black!99] at (-4, 11) {\Strichmaxerl[3][62][29]};
			
			\node[line width=0.2mm, color=black!78] at (14, 11) {\Strichmaxerl[1][70][67]};
			\draw [line width=0.4mm, color=black!24](-3, 8) circle (0.2);
			\draw[line width=0.5mm, color=black!94](-4, 5) -- (-12, 5);
			\node[line width=0.7mm, color=black!31] at (-5, -3) {\Strichmaxerl[6][89][48]};
