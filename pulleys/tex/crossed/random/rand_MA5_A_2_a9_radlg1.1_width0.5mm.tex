...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.2mm, color=black!14] at (-6, 3) {\Strichmaxerl[1][49][20]};
			
			\node[line width=0.4mm, color=black!26] at (-5, 6) {\Strichmaxerl[3][48][3]};
			\draw[line width=0.5mm, color=black!65](-3, 1) -- (-5, 9);
			\draw[line width=0.5mm, color=black!70](13, 5) -- (13, 0);
			
			\draw[line width=0.6mm, color=black!33] (13, 2) rectangle (12, 7);
			\draw[line width=0.2mm, color=black!80] (-3, 2) rectangle (-2, 8);
			\node[line width=0.4mm, color=black!93] at (14, 0) {\Strichmaxerl[7][63][74]};
			\draw[line width=0.5mm, color=black!35](-7, 8) -- (-5, 3);
			...
			\centerarc[line width=0.5mm](6.7, 7.65)(30:180:1.2000000000000002);
			\draw[line width=0.5mm](7.732, 8.262) -- (9.256, 6.612);
			\centerarc[line width=0.5mm](8.2, 6)(160:211:-1.2000000000000002);
			\draw[line width=0.5mm](9.3276, 5.5896) -- (7.144, -0.324);
			\centerarc[line width=0.5mm](8.2, -0.9)(150:280:1.2000000000000002);
			\draw[line width=0.5mm](8.4083, -2.0818) -- (11, -1.8);
