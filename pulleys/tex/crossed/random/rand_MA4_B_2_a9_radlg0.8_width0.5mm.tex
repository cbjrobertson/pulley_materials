...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.6mm, color=black!34] (8, 4) rectangle (9, 0);
			
			\draw [line width=0.6mm, color=black!10](-8, 0) circle (1.9);
			\draw[line width=0.4mm, color=black!25] (7, 8) rectangle (10, 3);
			\draw [line width=0.2mm, color=black!84](7, 6) circle (0.6);
			
			\node[line width=0.7mm, color=black!88] at (6, 5) {\Strichmaxerl[5][38][47]};
			
			\draw [line width=0.5mm, color=black!43](-5, 2) circle (1.9);
