...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!97](-6, 7) -- (-4, 6);
			
			\draw[line width=0.5mm, color=black!22](-7, 8) -- (-10, 9);
			\draw[line width=0.5mm, color=black!97](9, 0) -- (13, -2);
			\draw[line width=0.3mm, color=black!24] (-3, -2) rectangle (-4, 7);
			\draw[line width=0.7mm, color=black!84] (8, 8) rectangle (9, 7);
			\draw [line width=0.6mm, color=black!37](8, 6) circle (0.1);
			\node[line width=0.7mm, color=black!19] at (10, 2) {\Strichmaxerl[2][36][79]};
			\draw [line width=0.6mm, color=black!49](-7, 5) circle (0.9);
			\draw [line width=0.5mm, color=black!66](11, 6) circle (2.2);
