...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!78](15, 12) -- (13, 5);
			
			\node[line width=0.6mm, color=black!93] at (18, 0) {\Strichmaxerl[2][89][88]};
			\draw [line width=0.7mm, color=black!61](18, -1) circle (0.9);
