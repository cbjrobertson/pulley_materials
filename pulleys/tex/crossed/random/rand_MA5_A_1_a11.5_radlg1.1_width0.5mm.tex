...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!14](16, 4) -- (16, -3);
			
			\draw[line width=0.3mm, color=black!18] (14, 5) rectangle (16, 7);
			\draw [line width=0.2mm, color=black!51](-3, 0) circle (2.0);
			\node[line width=0.2mm, color=black!72] at (-2, 3) {\Strichmaxerl[3][73][61]};
			\node[line width=0.6mm, color=black!11] at (16, 0) {\Strichmaxerl[1][45][51]};
			
			\draw[line width=0.5mm, color=black!43] (-4, 1) rectangle (-4, 8);
			\draw[line width=0.7mm, color=black!67] (-2, 9) rectangle (-4, 8);
