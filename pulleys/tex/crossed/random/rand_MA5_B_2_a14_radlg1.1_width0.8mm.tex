...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.2mm, color=black!33] (7, 5) rectangle (8, -3);
			
			\draw[line width=0.6mm, color=black!22] (5, 6) rectangle (8, -2);
			\draw [line width=0.2mm, color=black!68](9, 1) circle (0.8);
			\draw[line width=0.7mm, color=black!13] (7, -3) rectangle (5, 8);
			\draw[line width=0.5mm, color=black!67](-11, 12) -- (-10, 8);
			\draw[line width=0.5mm, color=black!89](6, -2) -- (7, -3);
			
			\draw [line width=0.5mm, color=black!51](10, 7) circle (0.1);
			\draw[line width=0.5mm, color=black!25](10, 9) -- (7, 7);
			\node[line width=0.3mm, color=black!37] at (-9, -1) {\Strichmaxerl[3][6][80]};
			
			\node[line width=0.7mm, color=black!39] at (12, 7) {\Strichmaxerl[2][41][64]};
			\node[line width=0.4mm, color=black!96] at (-10, 13) {\Strichmaxerl[2][17][25]};
