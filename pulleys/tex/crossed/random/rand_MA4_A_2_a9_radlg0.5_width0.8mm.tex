...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.2mm, color=black!13] (13, 1) rectangle (12, 0);
			
			\draw [line width=0.3mm, color=black!89](13, 2) circle (0.6);
			\draw[line width=0.5mm, color=black!48](12, 2) -- (16, 7);
			\draw [line width=0.6mm, color=black!60](16, 1) circle (0.7);
			\node[line width=0.7mm, color=black!73] at (-6, 7) {\Strichmaxerl[5][74][1]};
			\node[line width=0.7mm, color=black!55] at (17, 2) {\Strichmaxerl[4][87][68]};
			\draw[line width=0.5mm, color=black!61](12, 8) -- (21, -2);
			\draw[line width=0.5mm, color=black!86](15, 9) -- (17, 2);
			\draw[line width=0.3mm, color=black!77] (-4, 9) rectangle (-4, 0);
			\draw[line width=0.2mm, color=black!95] (14, 3) rectangle (13, 3);
			\draw[line width=0.5mm, color=black!59](17, 1) -- (18, 3);
