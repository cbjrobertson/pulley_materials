...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.3mm, color=black!61] (-4, 6) rectangle (-5, 13);
			
			\draw [line width=0.2mm, color=black!95](10, 8) circle (0.5);
			\draw[line width=0.5mm, color=black!31] (-4, 14) rectangle (-7, 9);
			\draw [line width=0.2mm, color=black!80](-4, 0) circle (1.6);
			\draw [line width=0.7mm, color=black!88](8, 4) circle (2.4);
			\draw[line width=0.5mm, color=black!44](9, 12) -- (13, 1);
