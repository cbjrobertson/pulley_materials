...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!18](12, 9) -- (15, 14);
			
			\draw[line width=0.5mm, color=black!55](16, 10) -- (17, 12);
			\node[line width=0.5mm, color=black!27] at (16, 1) {\Strichmaxerl[5][66][20]};
			\draw[line width=0.2mm, color=black!10] (12, 0) rectangle (13, -1);
			\draw[line width=0.5mm, color=black!60](15, -1) -- (13, 4);
			\node[line width=0.7mm, color=black!96] at (-2, 4) {\Strichmaxerl[2][18][58]};
			
			\draw [line width=0.7mm, color=black!32](-6, 7) circle (0.6);
			
			\node[line width=0.7mm, color=black!29] at (15, -1) {\Strichmaxerl[5][37][33]};
			\draw[line width=0.5mm, color=black!58](-7, 2) -- (-10, 12);
			\node[line width=0.2mm, color=black!73] at (19, 10) {\Strichmaxerl[2][37][63]};
