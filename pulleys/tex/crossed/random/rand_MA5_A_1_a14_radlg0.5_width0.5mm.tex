...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!70](14, 14) -- (18, -3);
			
			\draw [line width=0.7mm, color=black!22](-4, 12) circle (0.0);
			\draw[line width=0.5mm, color=black!48] (12, 9) rectangle (13, 5);
			\draw [line width=0.4mm, color=black!62](16, 10) circle (0.0);
			\draw [line width=0.7mm, color=black!13](18, 2) circle (2.3);
			\draw [line width=0.3mm, color=black!69](-8, 5) circle (2.0);
			
			\draw [line width=0.3mm, color=black!72](-3, 10) circle (2.0);
			
			\draw [line width=0.3mm, color=black!51](-3, 3) circle (0.7);
			\node[line width=0.7mm, color=black!38] at (-6, 0) {\Strichmaxerl[5][65][67]};
			
			\draw [line width=0.3mm, color=black!45](17, 12) circle (2.3);
			
			\node[line width=0.6mm, color=black!21] at (15, 0) {\Strichmaxerl[2][37][53]};
			
			\draw [line width=0.5mm, color=black!77](12, 8) circle (1.1);
			\draw [line width=0.3mm, color=black!29](15, 9) circle (1.8);
