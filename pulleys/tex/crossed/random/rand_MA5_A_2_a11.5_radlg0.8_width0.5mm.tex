...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.2mm, color=black!60] (13, 7) rectangle (14, 5);
			
			\draw [line width=0.2mm, color=black!58](12, 4) circle (0.7);
			\draw[line width=0.5mm, color=black!58](-5, -3) -- (-11, 1);
			\draw [line width=0.5mm, color=black!47](-7, 4) circle (0.0);
			\draw [line width=0.2mm, color=black!52](16, 11) circle (1.7);
			\draw [line width=0.5mm, color=black!86](13, 5) circle (0.7);
			...
			\centerarc[line width=0.5mm](6.7, 9.775)(30:180:0.9);
			\draw[line width=0.5mm](7.474, 10.234) -- (8.992, 6.459);
			\centerarc[line width=0.5mm](8.2, 6.0)(160:211:-0.9);
			\draw[line width=0.5mm](9.0457, 5.6922) -- (7.408, -0.718);
			\centerarc[line width=0.5mm](8.2, -1.15)(150:280:0.9);
			\draw[line width=0.5mm](8.3562, -2.0363) -- (11, -1.8);
