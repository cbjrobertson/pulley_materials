...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.3mm, color=black!26] at (-2, 2) {\Strichmaxerl[4][77][60]};
			
			\node[line width=0.6mm, color=black!40] at (13, 8) {\Strichmaxerl[3][18][7]};
			\draw[line width=0.4mm, color=black!23] (-4, 1) rectangle (-4, 8);
			\draw[line width=0.2mm, color=black!85] (-2, -2) rectangle (-4, 9);
			
			\draw[line width=0.5mm, color=black!95] (-3, -3) rectangle (-5, 8);
