...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\centerarc[line width=0.8mm](6.7, 7.65)(0:180:0.6);
			\draw[line width=0.8mm](7.3, 7.65) --  (7.6, 2);
			\centerarc[line width=0.8mm](8.2, 2)(180:220:0.6);
			\draw[line width=0.8mm](7.7404, 1.6143) -- (11, -2);
			
			\node at (11.3, -2) {\Strichmaxerl[10][-35][-50]};
			
			\draw[line width=0.2mm, color=black!52] (14, 8) rectangle (13, 6);
			
			\draw[line width=0.7mm, color=black!54] (12, 4) rectangle (13, -1);
			\draw[line width=0.2mm, color=black!92] (-4, 7) rectangle (-4, 0);
			\draw[line width=0.5mm, color=black!70](-3, -3) -- (-11, 0);
			\draw [line width=0.6mm, color=black!98](-8, 1) circle (1.6);
			\draw [line width=0.5mm, color=black!81](16, 7) circle (0.1);
			\node[line width=0.3mm, color=black!87] at (-10, 6) {\Strichmaxerl[2][82][7]};
			\draw[line width=0.5mm, color=black!77](-3, 6) -- (-10, 7);
			\draw[line width=0.5mm, color=black!23](-5, 4) -- (-12, 3);
			\draw[line width=0.7mm, color=black!34] (-2, 5) rectangle (-3, -3);
			
			\draw[line width=0.5mm, color=black!87](15, 7) -- (18, -2);
