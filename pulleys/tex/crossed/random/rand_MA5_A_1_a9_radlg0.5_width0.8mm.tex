...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.4mm, color=black!67] (-3, -2) rectangle (-4, 3);
			
			\draw[line width=0.6mm, color=black!19] (-3, -1) rectangle (-3, -1);
			\draw[line width=0.5mm, color=black!89](-4, 3) -- (-6, 1);
			\node[line width=0.3mm, color=black!75] at (14, 6) {\Strichmaxerl[2][68][1]};
			
			\draw[line width=0.5mm, color=black!33](-4, 7) -- (-9, -2);
			\node[line width=0.2mm, color=black!69] at (-6, -1) {\Strichmaxerl[4][24][37]};
			
			\draw[line width=0.5mm, color=black!95](16, 4) -- (12, -2);
			\draw [line width=0.5mm, color=black!87](18, 3) circle (0.5);
			\draw[line width=0.5mm, color=black!60](-3, 3) -- (-12, 3);
