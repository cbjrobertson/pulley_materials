...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.2mm, color=black!90] (-3, -2) rectangle (-3, 1);
			
			\draw[line width=0.5mm, color=black!85](-2, 8) -- (-7, 5);
			\draw [line width=0.4mm, color=black!65](-4, 0) circle (0.5);
			\draw[line width=0.5mm, color=black!69](-7, -3) -- (-11, 1);
			\draw[line width=0.2mm, color=black!84] (13, 4) rectangle (12, 8);
			\draw [line width=0.2mm, color=black!41](-7, -1) circle (1.6);
