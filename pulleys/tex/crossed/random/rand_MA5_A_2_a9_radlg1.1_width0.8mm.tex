...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\centerarc[line width=0.8mm](6.7, 7.65)(30:180:1.2000000000000002);
			\draw[line width=0.8mm](7.732, 8.262) -- (9.256, 6.612);
			\centerarc[line width=0.8mm](8.2, 6)(160:211:-1.2000000000000002);
			\draw[line width=0.8mm](9.3276, 5.5896) -- (7.144, -0.324);
			\centerarc[line width=0.8mm](8.2, -0.9)(150:280:1.2000000000000002);
			\draw[line width=0.8mm](8.4083, -2.0818) -- (11, -1.8);
			
			\draw[line width=0.5mm, color=black!44](17, -1) -- (12, 6);
			
			\draw[line width=0.4mm, color=black!99] (-4, -3) rectangle (-6, 4);
			\draw [line width=0.2mm, color=black!75](-3, 2) circle (2.3);
			\node[line width=0.7mm, color=black!87] at (14, -2) {\Strichmaxerl[3][3][32]};
			\draw[line width=0.5mm, color=black!35](-7, 2) -- (-4, 7);
			
			\node[line width=0.2mm, color=black!94] at (16, -2) {\Strichmaxerl[2][39][89]};
			
			\draw [line width=0.4mm, color=black!67](-7, 2) circle (1.2);
			\draw[line width=0.5mm, color=black!65](-3, -1) -- (-8, 0);
