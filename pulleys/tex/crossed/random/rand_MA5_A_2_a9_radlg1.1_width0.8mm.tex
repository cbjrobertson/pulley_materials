...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.3mm, color=black!88] at (-5, 3) {\Strichmaxerl[2][43][66]};
			
			\node[line width=0.4mm, color=black!58] at (15, 1) {\Strichmaxerl[2][68][33]};
			\draw [line width=0.6mm, color=black!74](-7, 4) circle (1.7);
			\draw [line width=0.5mm, color=black!57](-11, -2) circle (0.2);
			
			\node[line width=0.6mm, color=black!86] at (-3, 4) {\Strichmaxerl[4][47][16]};
