...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.5mm, color=black!51](7, 4) circle (2.1);
			
			\draw[line width=0.5mm, color=black!24](-7, 2) -- (-11, -1);
			\draw[line width=0.3mm, color=black!61] (-8, 5) rectangle (-6, 8);
			\draw [line width=0.3mm, color=black!87](-14, 3) circle (0.5);
			\draw [line width=0.6mm, color=black!98](-7, 3) circle (0.7);
			\draw[line width=0.4mm, color=black!20] (5, 8) rectangle (6, 0);
			\node[line width=0.4mm, color=black!73] at (9, 5) {\Strichmaxerl[6][74][66]};
			
			\node[line width=0.2mm, color=black!36] at (-7, 0) {\Strichmaxerl[7][43][36]};
			\draw[line width=0.4mm, color=black!18] (7, 4) rectangle (7, -2);
			
			\draw[line width=0.7mm, color=black!27] (-8, 6) rectangle (-6, 7);
