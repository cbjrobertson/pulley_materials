...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.3mm, color=black!65](-7, 5) circle (1.2);
			
			\draw[line width=0.5mm, color=black!87](8, 8) -- (16, 5);
			\draw[line width=0.4mm, color=black!19] (-4, 7) rectangle (-7, 6);
			\draw[line width=0.5mm, color=black!56](6, 6) -- (8, 12);
			\draw[line width=0.3mm, color=black!13] (7, 11) rectangle (6, 0);
			
			\draw[line width=0.6mm, color=black!91] (-6, 10) rectangle (-6, 9);
			\draw[line width=0.5mm, color=black!62](11, 4) -- (8, 2);
