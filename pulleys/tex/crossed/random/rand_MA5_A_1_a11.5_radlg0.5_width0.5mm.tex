...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.7mm, color=black!14] at (16, 3) {\Strichmaxerl[2][19][75]};
			
			\draw[line width=0.2mm, color=black!36] (13, 10) rectangle (13, 12);
			\node[line width=0.5mm, color=black!54] at (18, 2) {\Strichmaxerl[2][61][50]};
			\draw [line width=0.5mm, color=black!30](-7, 2) circle (0.9);
			\node[line width=0.4mm, color=black!43] at (14, -2) {\Strichmaxerl[7][73][26]};
