...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.5mm, color=black!67](22, 2) circle (0.8);
			
			\draw [line width=0.2mm, color=black!38](-7, -3) circle (1.5);
			\node[line width=0.5mm, color=black!97] at (14, 6) {\Strichmaxerl[2][53][7]};
			\draw[line width=0.4mm, color=black!93] (-4, 1) rectangle (-4, 3);
			
			\node[line width=0.2mm, color=black!74] at (17, 5) {\Strichmaxerl[3][2][0]};
			\draw [line width=0.6mm, color=black!56](-4, 6) circle (2.4);
			\node[line width=0.5mm, color=black!72] at (13, 2) {\Strichmaxerl[6][25][84]};
			\node[line width=0.7mm, color=black!27] at (16, -3) {\Strichmaxerl[2][54][83]};
			\draw[line width=0.5mm, color=black!81](-7, -2) -- (-5, 9);
