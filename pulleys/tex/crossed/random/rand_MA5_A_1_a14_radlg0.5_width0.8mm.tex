...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!41](12, 12) -- (15, 7);
			
			\draw[line width=0.6mm, color=black!97] (12, 11) rectangle (13, 4);
			\draw[line width=0.5mm, color=black!29](-7, 7) -- (-8, 1);
			\draw[line width=0.5mm, color=black!88](12, 6) -- (22, 8);
			
			\draw[line width=0.2mm, color=black!77] (13, 8) rectangle (16, 0);
			\node[line width=0.3mm, color=black!26] at (15, 2) {\Strichmaxerl[4][60][78]};
			\draw [line width=0.5mm, color=black!97](-5, 0) circle (2.3);
			
			\draw[line width=0.5mm, color=black!36](16, 3) -- (15, 13);
			\node[line width=0.4mm, color=black!29] at (14, -1) {\Strichmaxerl[7][64][42]};
