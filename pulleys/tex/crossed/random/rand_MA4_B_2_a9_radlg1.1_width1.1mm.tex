...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.6mm, color=black!51](7, 4) circle (0.8);
			
			\draw[line width=0.5mm, color=black!84](9, -1) -- (16, -2);
			\draw[line width=0.5mm, color=black!57](-8, 0) -- (-14, 2);
			\node[line width=0.5mm, color=black!58] at (-10, 0) {\Strichmaxerl[4][52][16]};
			
			\draw[line width=0.5mm, color=black!96](-9, 9) -- (-9, -2);
			\draw[line width=0.7mm, color=black!38] (-4, 9) rectangle (-7, 2);
			\draw[line width=0.4mm, color=black!87] (-6, 6) rectangle (-7, 7);
			\draw[line width=0.5mm, color=black!94](-6, -2) -- (-7, 7);
			\draw[line width=0.5mm, color=black!34] (7, 8) rectangle (7, 7);
			\node[line width=0.3mm, color=black!42] at (-5, 4) {\Strichmaxerl[4][21][21]};
			\draw [line width=0.2mm, color=black!74](11, -3) circle (2.2);
			...
			\draw[line width=1.1mm] (0.45, 10) -- (-3.02, 6.96);
			\centerarc[line width=1.1mm](-2, 6.3)(135:180:1.2000000000000002);
			\draw[line width=1.1mm] (-3.2, 6.3) -- (-3.2, 2.7);
			\centerarc[line width=1.1mm](-2, 2.7)(180:270:1.2000000000000002);
