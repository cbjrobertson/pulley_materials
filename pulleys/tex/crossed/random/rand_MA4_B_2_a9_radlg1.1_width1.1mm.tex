...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.7mm, color=black!76](8, 6) circle (1.7);
			
			\draw[line width=0.5mm, color=black!69](9, 8) -- (13, 1);
			\node[line width=0.3mm, color=black!20] at (11, 7) {\Strichmaxerl[7][53][11]};
			\draw[line width=0.5mm, color=black!13](-4, 4) -- (-6, 3);
			\draw [line width=0.3mm, color=black!19](-7, 5) circle (0.9);
			\draw [line width=0.3mm, color=black!82](-4, 1) circle (0.9);
