...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.6mm, color=black!83] (-5, 8) rectangle (-5, 8);
			
			\draw [line width=0.2mm, color=black!25](13, -3) circle (0.0);
			\draw [line width=0.2mm, color=black!93](-8, -1) circle (2.0);
			\node[line width=0.6mm, color=black!36] at (10, 7) {\Strichmaxerl[6][44][65]};
			\draw[line width=0.5mm, color=black!49] (8, 6) rectangle (8, 3);
			\draw[line width=0.4mm, color=black!94] (8, 3) rectangle (8, 8);
			\draw [line width=0.2mm, color=black!95](6, 7) circle (2.4);
			\node[line width=0.6mm, color=black!21] at (-5, 1) {\Strichmaxerl[2][31][45]};
			\draw[line width=0.5mm, color=black!67] (-5, 4) rectangle (-4, 11);
			\draw[line width=0.5mm, color=black!34](8, -1) -- (11, 4);
			
			\draw [line width=0.3mm, color=black!65](-8, 7) circle (0.8);
			\node[line width=0.3mm, color=black!46] at (15, -1) {\Strichmaxerl[2][40][54]};
			\draw[line width=0.5mm, color=black!53] (-3, 3) rectangle (-7, 6);
			
			\draw[line width=0.5mm, color=black!96](-3, 10) -- (-3, 7);
			\draw[line width=0.5mm, color=black!64](-4, -2) -- (-9, -1);
			\draw [line width=0.6mm, color=black!80](8, 7) circle (2.0);
			\draw[line width=0.5mm, color=black!34] (-4, 5) rectangle (-3, 1);
			\draw[line width=0.5mm, color=black!60](-8, 5) -- (-3, 11);
			\draw[line width=0.7mm, color=black!30] (7, 6) rectangle (9, 4);
