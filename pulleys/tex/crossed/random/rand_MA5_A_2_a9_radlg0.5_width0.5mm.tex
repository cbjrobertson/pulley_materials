...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.4mm, color=black!26] at (18, 2) {\Strichmaxerl[6][47][32]};
			
			\node[line width=0.7mm, color=black!40] at (16, 1) {\Strichmaxerl[6][3][31]};
			\node[line width=0.7mm, color=black!15] at (-5, 2) {\Strichmaxerl[2][70][85]};
			\draw [line width=0.5mm, color=black!72](-4, 7) circle (1.6);
			\node[line width=0.2mm, color=black!49] at (-5, 0) {\Strichmaxerl[6][88][43]};
