...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.7mm, color=black!44](-6, 4) circle (0.4);
			
			\node[line width=0.6mm, color=black!19] at (11, 9) {\Strichmaxerl[7][37][80]};
			\draw[line width=0.6mm, color=black!39] (-4, 6) rectangle (-5, 3);
			\draw[line width=0.3mm, color=black!30] (-5, 3) rectangle (-7, -3);
			\draw[line width=0.4mm, color=black!26] (6, 1) rectangle (10, 3);
			\draw [line width=0.4mm, color=black!98](-4, 2) circle (0.4);
			\draw[line width=0.5mm, color=black!51] (-4, 11) rectangle (-3, 5);
			\draw [line width=0.2mm, color=black!67](8, 7) circle (0.0);
			\draw[line width=0.5mm, color=black!11](11, 0) -- (6, 0);
			\draw [line width=0.2mm, color=black!36](-5, -1) circle (0.2);
			\draw[line width=0.5mm, color=black!55](-8, 7) -- (-13, -3);
