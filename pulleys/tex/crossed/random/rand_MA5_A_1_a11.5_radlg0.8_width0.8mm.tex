...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!75](-2, 8) -- (-8, 4);
			
			\draw[line width=0.5mm, color=black!94](-4, 2) -- (-7, 3);
			\draw[line width=0.5mm, color=black!74](-3, -3) -- (-12, -2);
			\draw [line width=0.5mm, color=black!17](-12, 4) circle (0.2);
			\node[line width=0.4mm, color=black!84] at (-7, 7) {\Strichmaxerl[5][51][20]};
			\draw [line width=0.4mm, color=black!99](-7, 5) circle (1.8);
