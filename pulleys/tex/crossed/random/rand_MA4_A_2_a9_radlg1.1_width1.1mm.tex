...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!91](-4, 1) -- (-11, 6);
			
			\node[line width=0.3mm, color=black!17] at (13, 0) {\Strichmaxerl[2][75][65]};
			\draw[line width=0.6mm, color=black!24] (12, 1) rectangle (13, -3);
			\draw[line width=0.4mm, color=black!28] (12, 0) rectangle (14, 0);
			\draw[line width=0.5mm, color=black!71](12, 1) -- (16, 0);
			\node[line width=0.5mm, color=black!59] at (15, 1) {\Strichmaxerl[1][7][27]};
			\draw[line width=0.2mm, color=black!39] (-4, 0) rectangle (-3, 5);
			\draw[line width=0.5mm, color=black!53] (-2, -2) rectangle (-6, -3);
			\draw[line width=0.4mm, color=black!62] (-3, -1) rectangle (-4, -3);
			\node[line width=0.3mm, color=black!48] at (18, 7) {\Strichmaxerl[7][59][9]};
			\draw[line width=0.5mm, color=black!94] (14, -3) rectangle (12, 0);
			\draw[line width=0.7mm, color=black!22] (14, 2) rectangle (14, 8);
			\node[line width=0.2mm, color=black!37] at (17, -3) {\Strichmaxerl[4][43][25]};
			
			\draw[line width=0.5mm, color=black!19](-4, 7) -- (-5, 6);
			\draw [line width=0.3mm, color=black!85](-7, -3) circle (1.3);
			\draw [line width=0.4mm, color=black!89](15, 3) circle (1.3);
			
			\draw[line width=0.4mm, color=black!15] (12, -1) rectangle (14, 7);
