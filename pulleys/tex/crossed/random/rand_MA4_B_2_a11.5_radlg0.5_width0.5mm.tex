...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!76](-9, 10) -- (-9, 0);
			
			\draw[line width=0.2mm, color=black!59] (-5, 5) rectangle (-8, 1);
			\draw[line width=0.6mm, color=black!35] (6, 5) rectangle (10, -1);
			\node[line width=0.4mm, color=black!33] at (11, 7) {\Strichmaxerl[2][82][25]};
			\draw[line width=0.5mm, color=black!27](7, 7) -- (13, 8);
			
			\node[line width=0.2mm, color=black!24] at (8, 9) {\Strichmaxerl[7][17][41]};
			
			\draw [line width=0.5mm, color=black!27](-6, -2) circle (1.5);
			
			\draw[line width=0.3mm, color=black!32] (-4, -2) rectangle (-7, 5);
			\draw[line width=0.5mm, color=black!56](-5, 12) -- (-7, 11);
			\draw[line width=0.5mm, color=black!30](-6, 4) -- (-6, 1);
			\draw[line width=0.5mm, color=black!21](-7, 10) -- (-14, -2);
