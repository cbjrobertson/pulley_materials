...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!27](-5, 7) -- (-8, 6);
			
			\node[line width=0.7mm, color=black!29] at (7, 3) {\Strichmaxerl[4][7][33]};
			\draw[line width=0.2mm, color=black!49] (6, -2) rectangle (8, 6);
			\draw[line width=0.5mm, color=black!61] (7, 9) rectangle (7, 2);
			\node[line width=0.3mm, color=black!38] at (9, 7) {\Strichmaxerl[3][24][17]};
			\draw [line width=0.3mm, color=black!98](11, 6) circle (0.4);
			
			\draw[line width=0.5mm, color=black!29](-4, 4) -- (-12, 1);
			
			\draw [line width=0.7mm, color=black!71](14, 0) circle (2.1);
			\draw[line width=0.4mm, color=black!47] (6, 1) rectangle (7, 2);
