...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.6mm, color=black!96](-7, 1) circle (0.9);
			
			\draw [line width=0.3mm, color=black!47](17, 11) circle (1.2);
			\draw [line width=0.2mm, color=black!24](-11, 13) circle (0.2);
			\draw[line width=0.4mm, color=black!59] (-2, 11) rectangle (-2, -2);
			\draw [line width=0.7mm, color=black!93](-6, -2) circle (0.7);
			\draw [line width=0.2mm, color=black!85](18, -3) circle (2.2);
			
			\draw[line width=0.3mm, color=black!27] (-4, 9) rectangle (-2, 1);
