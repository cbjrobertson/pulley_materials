...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.7mm, color=black!87] (12, 9) rectangle (13, 12);
			
			\draw[line width=0.2mm, color=black!82] (-2, 4) rectangle (-3, 9);
			\draw[line width=0.5mm, color=black!41](15, 11) -- (17, 11);
			\draw[line width=0.5mm, color=black!82](17, 2) -- (14, 8);
			\draw[line width=0.6mm, color=black!40] (-3, 2) rectangle (-3, 0);
			
			\draw[line width=0.5mm, color=black!50](15, -3) -- (19, 5);
			
			\draw[line width=0.5mm, color=black!95](13, 0) -- (18, 4);
			\draw[line width=0.5mm, color=black!63](-5, 5) -- (-10, 2);
			\draw [line width=0.6mm, color=black!77](-10, 3) circle (1.2);
			\draw[line width=0.5mm, color=black!13](-6, 10) -- (-5, 8);
			\draw [line width=0.4mm, color=black!77](12, 1) circle (0.7);
