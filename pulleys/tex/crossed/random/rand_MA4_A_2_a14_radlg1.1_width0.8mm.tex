...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!27](-7, 10) -- (-2, 7);
			
			\draw[line width=0.2mm, color=black!81] (-2, 14) rectangle (-4, 4);
			\node[line width=0.7mm, color=black!38] at (-6, 6) {\Strichmaxerl[5][74][4]};
			\node[line width=0.4mm, color=black!20] at (17, 4) {\Strichmaxerl[7][28][70]};
			
			\node[line width=0.4mm, color=black!15] at (16, 3) {\Strichmaxerl[1][30][6]};
			\draw [line width=0.7mm, color=black!53](16, 0) circle (0.2);
			
			\node[line width=0.7mm, color=black!73] at (-5, 0) {\Strichmaxerl[2][18][76]};
			\draw[line width=0.2mm, color=black!28] (13, 7) rectangle (16, 13);
			\draw[line width=0.5mm, color=black!80] (-2, 9) rectangle (-2, 5);
