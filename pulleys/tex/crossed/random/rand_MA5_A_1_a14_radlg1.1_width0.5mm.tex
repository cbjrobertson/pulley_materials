...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.4mm, color=black!83] (13, 7) rectangle (16, 9);
			
			\node[line width=0.7mm, color=black!56] at (-3, 7) {\Strichmaxerl[7][70][65]};
			\draw[line width=0.3mm, color=black!67] (-3, 3) rectangle (-3, 4);
			\draw [line width=0.2mm, color=black!51](-2, 0) circle (1.3);
			\draw[line width=0.5mm, color=black!100](-7, 12) -- (-6, 2);
			\draw[line width=0.5mm, color=black!93](-2, 12) -- (-10, 5);
			\draw[line width=0.5mm, color=black!79](17, 4) -- (20, -2);
			\draw[line width=0.5mm, color=black!41](14, 10) -- (17, 4);
			\draw[line width=0.5mm, color=black!29](16, 5) -- (19, 4);
