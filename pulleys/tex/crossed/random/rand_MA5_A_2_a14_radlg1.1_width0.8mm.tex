...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!52](-2, 10) -- (-2, 4);
			
			\draw[line width=0.5mm, color=black!42](15, -1) -- (21, 11);
			\draw[line width=0.5mm, color=black!78](12, 2) -- (15, 12);
			\draw[line width=0.5mm, color=black!21] (-3, 12) rectangle (-2, 12);
