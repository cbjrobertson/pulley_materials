...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\node[line width=0.6mm, color=black!32] at (17, -3) {\Strichmaxerl[7][88][45]};
			
			\node[line width=0.6mm, color=black!44] at (-8, 4) {\Strichmaxerl[5][51][50]};
			\draw[line width=0.5mm, color=black!54](17, -3) -- (20, -2);
			\draw[line width=0.5mm, color=black!68](12, 7) -- (16, 3);
			
			\draw[line width=0.5mm, color=black!31](16, 9) -- (22, 8);
