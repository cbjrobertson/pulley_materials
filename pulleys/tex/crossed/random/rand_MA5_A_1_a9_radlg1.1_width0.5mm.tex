...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.6mm, color=black!84] (13, 9) rectangle (14, 2);
			
			\draw[line width=0.5mm, color=black!40] (13, 1) rectangle (13, 7);
			\draw [line width=0.2mm, color=black!85](18, -2) circle (2.4);
			\draw[line width=0.7mm, color=black!75] (12, 7) rectangle (12, -2);
			\node[line width=0.3mm, color=black!11] at (-7, 4) {\Strichmaxerl[7][9][10]};
			
			\draw[line width=0.6mm, color=black!30] (-2, 7) rectangle (-5, 3);
			
			\draw[line width=0.5mm, color=black!90](-4, 7) -- (-10, -3);
			
			\draw[line width=0.2mm, color=black!52] (13, 5) rectangle (12, 4);
			\draw[line width=0.3mm, color=black!80] (13, 5) rectangle (12, 2);
			\draw[line width=0.5mm, color=black!42](13, -1) -- (15, -1);
			\draw[line width=0.4mm, color=black!25] (-2, 6) rectangle (-2, 9);
			\draw [line width=0.6mm, color=black!45](-3, 1) circle (1.0);
			...
			\centerarc[line width=0.5mm](6.7, 7.65)(0:180:1.2000000000000002);
			\draw[line width=0.5mm](7.9, 7.65) --  (7.0, 2);
