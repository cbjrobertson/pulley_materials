...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!71](-2, 5) -- (-4, 1);
			
			\draw[line width=0.4mm, color=black!32] (14, 7) rectangle (16, 4);
			\node[line width=0.2mm, color=black!52] at (13, 1) {\Strichmaxerl[3][8][69]};
			\draw[line width=0.4mm, color=black!60] (13, 7) rectangle (15, 6);
