...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.5mm, color=black!17](-7, 4) circle (1.6);
			
			\draw [line width=0.2mm, color=black!95](16, 7) circle (0.0);
			\draw [line width=0.7mm, color=black!72](15, 3) circle (1.8);
			\draw[line width=0.3mm, color=black!85] (-2, 2) rectangle (-4, 5);
			
			\draw[line width=0.5mm, color=black!62](-6, 2) -- (-6, -1);
			\draw[line width=0.6mm, color=black!16] (-2, 4) rectangle (-5, 1);
			
			\draw[line width=0.2mm, color=black!42] (14, 6) rectangle (13, -3);
			...
			\centerarc[line width=1.1mm](6.7, 7.65)(30:180:0.6);
			\draw[line width=1.1mm](7.216, 7.956) -- (8.728, 6.306);
			\centerarc[line width=1.1mm](8.2, 6)(160:211:-0.6);
			\draw[line width=1.1mm](8.7638, 5.7948) -- (7.672, -0.612);
			\centerarc[line width=1.1mm](8.2, -0.9)(150:280:0.6);
			\draw[line width=1.1mm](8.3042, -1.4909) -- (11, -1.8);
