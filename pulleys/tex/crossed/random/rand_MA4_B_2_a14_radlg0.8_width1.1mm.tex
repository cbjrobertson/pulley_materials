...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!56](10, 11) -- (14, 4);
			
			\draw [line width=0.5mm, color=black!75](-6, 2) circle (1.9);
			\node[line width=0.4mm, color=black!47] at (7, 1) {\Strichmaxerl[1][72][84]};
			\draw[line width=0.5mm, color=black!15](-5, 11) -- (-13, 1);
			\draw[line width=0.5mm, color=black!18] (6, 4) rectangle (10, 0);
			\draw [line width=0.3mm, color=black!71](-5, 4) circle (2.4);
			
			\draw[line width=0.3mm, color=black!50] (-4, 14) rectangle (-7, 6);
			
			\draw[line width=0.5mm, color=black!42](7, 4) -- (7, 1);
			\draw[line width=0.5mm, color=black!63](8, 2) -- (15, 5);
