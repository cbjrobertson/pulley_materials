...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.7mm, color=black!67](21, 6) circle (1.1);
			
			\draw[line width=0.6mm, color=black!48] (-2, 7) rectangle (-2, 6);
			\draw[line width=0.7mm, color=black!50] (-2, -1) rectangle (-3, 4);
			\draw[line width=0.5mm, color=black!18](-3, 4) -- (-7, 11);
			
			\draw [line width=0.5mm, color=black!69](-6, 7) circle (1.8);
			\draw[line width=0.3mm, color=black!57] (12, 9) rectangle (14, -1);
			\draw [line width=0.7mm, color=black!39](-3, 8) circle (2.2);
			
			\draw[line width=0.2mm, color=black!36] (12, 6) rectangle (15, -1);
			\draw [line width=0.7mm, color=black!59](-10, 2) circle (0.8);
			\node[line width=0.6mm, color=black!37] at (18, 0) {\Strichmaxerl[4][87][53]};
			
			\draw[line width=0.5mm, color=black!79](-2, 12) -- (-11, 3);
			\draw[line width=0.5mm, color=black!25](13, -1) -- (19, 11);
			\draw [line width=0.5mm, color=black!80](-4, 8) circle (2.4);
			
			\draw [line width=0.3mm, color=black!54](-5, 3) circle (2.3);
			\draw[line width=0.5mm, color=black!12] (13, -3) rectangle (16, 8);
