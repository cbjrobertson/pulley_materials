...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!90](-6, 11) -- (-8, 1);
			
			\draw [line width=0.6mm, color=black!74](10, -1) circle (1.6);
			\draw[line width=0.5mm, color=black!23](-9, -3) -- (-13, 1);
			\node[line width=0.4mm, color=black!89] at (9, 6) {\Strichmaxerl[1][90][34]};
			
			\draw [line width=0.6mm, color=black!49](9, 6) circle (2.1);
			\node[line width=0.2mm, color=black!98] at (-6, 8) {\Strichmaxerl[6][54][25]};
			\draw[line width=0.7mm, color=black!79] (7, 3) rectangle (9, 1);
			
			\draw[line width=0.3mm, color=black!55] (-4, 8) rectangle (-6, 11);
