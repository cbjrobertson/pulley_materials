...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw[line width=0.5mm, color=black!57](-4, -3) -- (-3, 7);
			
			\draw[line width=0.3mm, color=black!47] (-4, 5) rectangle (-2, 8);
			\draw[line width=0.4mm, color=black!37] (14, -1) rectangle (14, 7);
			\draw [line width=0.4mm, color=black!66](15, 8) circle (0.6);
			\node[line width=0.5mm, color=black!59] at (16, 3) {\Strichmaxerl[2][37][90]};
			\draw[line width=0.5mm, color=black!51](-4, 1) -- (-12, 2);
