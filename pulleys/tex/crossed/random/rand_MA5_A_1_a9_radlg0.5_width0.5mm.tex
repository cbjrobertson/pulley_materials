...
\begin{document}
	\begin{figure}
		...
		\begin{tikzpicture}
			...
			\draw [line width=0.6mm, color=black!15](14, 1) circle (1.2);
			
			\draw [line width=0.4mm, color=black!41](-6, -3) circle (1.8);
			\draw[line width=0.5mm, color=black!67] (-3, 6) rectangle (-5, 3);
			\draw [line width=0.7mm, color=black!65](-2, 1) circle (1.3);
			\node[line width=0.4mm, color=black!74] at (-6, 1) {\Strichmaxerl[7][17][52]};
			\node[line width=0.7mm, color=black!65] at (14, 6) {\Strichmaxerl[6][32][49]};
			\draw[line width=0.5mm, color=black!10] (13, 5) rectangle (14, 4);
			
			\draw [line width=0.4mm, color=black!26](16, 1) circle (0.2);
			\draw[line width=0.3mm, color=black!87] (13, -1) rectangle (12, 6);
			
			\draw [line width=0.2mm, color=black!52](-3, 2) circle (2.0);
			\draw[line width=0.3mm, color=black!78] (-2, 8) rectangle (-5, 9);
			
			\draw [line width=0.6mm, color=black!31](-2, 0) circle (1.2);
			\draw [line width=0.2mm, color=black!74](-6, -1) circle (2.3);
			...
			\centerarc[line width=0.5mm](6.7, 7.65)(0:180:0.6);
			\draw[line width=0.5mm](7.3, 7.65) --  (7.6, 2);
