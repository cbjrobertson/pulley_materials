...
\begin{document}
	...
	\begin{figure}[H]
		\begin{tikzpicture}
			...
			\draw[line width=\width](\xthree+\radrp,\yh) --  (\xwalltwo-\radrp,\ywalltwo); 
			\centerarc[line width=\width](\xwalltwo,\ywalltwo)(180:220:\radrp);
			\draw[line width=\width]({\xwalltwo+\radrp*cos(220)},{\ywalltwo+\radrp*sin(220)}) -- (9.1, -2);
			
			\node at (9.5, -2) {\Strichmaxerl[10][-35][-50]};
