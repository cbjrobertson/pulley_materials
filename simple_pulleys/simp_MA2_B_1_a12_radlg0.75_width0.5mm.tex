...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (1.15, 12) -- (1.15, 3.6);
		\centerarc[line width=0.5mm](2, 3.6)(180:330:0.85);
		\draw[line width=0.5mm](1.158, 3.488) -- (3.869, 6.96);
		\centerarc[line width=0.5mm](4, 7.8)(390:325:0.85);
		\draw[line width=0.5mm](4.768, 8.164) -- (2.768, 12.414);
		\centerarc[line width=0.5mm](2, 12.05)(30:90:0.85);
		\draw[line width=0.5mm](2, 12.9) -- (-1, 13.15);
