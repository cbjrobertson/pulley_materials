...
\begin{document}
	\begin{tikzpicture}
		...
		\centerarc[line width=0.5mm](1, 8)(180:0:0.85)
		\draw[line width=0.5mm](1.85, 8) -- (2.65, 2.0);
		\centerarc[line width=0.5mm](3.5, 2.0)(180:300:0.85);
		\draw[line width=0.5mm](3.481, 1.15) -- (7.981, 3.15);
		\centerarc[line width=0.5mm](8, 4.0)(300:390:0.85);
		\draw[line width=0.5mm](8.768, 4.364) -- (7.05, 7.8);
