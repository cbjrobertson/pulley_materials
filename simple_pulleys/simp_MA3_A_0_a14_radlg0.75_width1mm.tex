...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width = 1mm] (1.15, 11.2) -- (1.15, 1.4);
		\centerarc[line width = 1mm](2, 11.2)(0:180:0.85);
		\draw[line width = 1mm] (2.85, 11.2) -- (3.1, 5.6);
		\draw[line width = 1mm] (2.25, 5.6) -- (2.25, 1.4);
		\centerarc[line width = 1mm](3.1, 5.6)(0:180:0.85);
		\draw[line width = 1mm] (3.95, 5.6) -- (4.6, -1.9);
