...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (-5.05, -1.8) -- (-4.1, 9.6);
		\centerarc[line width=0.75mm](-3.5, 9.6)(0:180:0.6);
		\draw[line width=0.75mm] (-2.9, 9.6) -- (-2.6, -1.2);
		\centerarc[line width=0.75mm](-2, -1.2)(180:360:0.6);
		\draw[line width=0.75mm] (-1.4, -1.2) -- (-1.6, 4.8);
		\draw[line width=0.75mm] (-1, 4.8) -- (0.6, 9.4);
		\draw[line width=0.75mm, fill=black](0.5, 8.8) rectangle (0.7, 9.4);
		\centerarc[line width=0.75mm](-1, 4.8)(-20:180:0.6);
		\draw[line width=0.75mm] (-0.755, 4.252) -- (0.792, 2.324);
		\centerarc[line width=0.75mm](0.5, 1.8)(160:380:0.6);
		\draw[line width=0.75mm] (0.956, 1.41) -- (0.6, 9.6);
		\draw[line width=0.75mm](0.5, 1.8) -- (0.75, -0.1);
		\centerarc[line width=0.75mm](1.2, 9.6)(0:180:0.6);
		\draw[line width=0.75mm] (1.8, 9.6) -- (1.75, -0.1);
