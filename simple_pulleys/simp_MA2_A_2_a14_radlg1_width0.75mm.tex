...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (-0.1, 14) -- (-0.1, 4.2);
		\centerarc[line width=0.75mm](1, 4.2)(180:360:1.1);
		\draw[line width=0.75mm](2.1, 4.2) -- (2.1, 11.2);
		\centerarc[line width=0.75mm](3.2, 11.2)(0:180:1.1);
		\draw[line width=0.75mm](4.3, 11.2) -- (4.9, -1);
		\centerarc[line width=0.75mm](6, -1)(180:360:1.1);
		\draw[line width=0.75mm](7.1, -1) -- (6.9, 2.8);
		\centerarc[line width=0.75mm](8, 2.8)(0:180:1.1);
		\draw[line width=0.75mm](9.1, 2.8) -- (9.1, -1.8);
