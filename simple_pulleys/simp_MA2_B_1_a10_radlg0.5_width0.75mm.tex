...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (1.4, 10) -- (1.4, 3.0);
		\centerarc[line width=0.75mm](2, 3.0)(180:330:0.6);
		\draw[line width=0.75mm](1.405, 2.921) -- (3.908, 5.907);
		\centerarc[line width=0.75mm](4, 6.5)(390:325:0.6);
		\draw[line width=0.75mm](4.542, 6.757) -- (2.542, 10.307);
		\centerarc[line width=0.75mm](2, 10.05)(30:90:0.6);
