...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (-1.4, -1.4) -- (-1.6, 5.6);
		\draw[line width=0.5mm] (-1, 5.6) -- (0.6, 11.0);
		\draw[line width=0.5mm, fill=black](0.5, 10.4) rectangle (0.7, 11.0);
		\centerarc[line width=0.5mm](-1, 5.6)(-20:180:0.6);
		\draw[line width=0.5mm] (-0.755, 5.052) -- (0.792, 2.624);
		\centerarc[line width=0.5mm](0.5, 2.1)(160:380:0.6);
		\draw[line width=0.5mm] (0.956, 1.71) -- (0.6, 11.2);
		\draw[line width=0.5mm](0.5, 2.1) -- (0.75, -0.2);
		\centerarc[line width=0.5mm](1.2, 11.2)(0:180:0.6);
		\draw[line width=0.5mm] (1.8, 11.2) -- (1.75, -0.2);
