...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm](1.85, 0.9) -- (2.1, 5.0);
		\draw[line width=0.5mm] (1.25, 10) -- (1.25, 5.0);
		\centerarc[line width=0.5mm](2.1, 5.0)(180:360:0.85);
		\draw[line width=0.5mm](2.95, 5.0) -- (2.95, 7.0);
		\centerarc[line width=0.5mm](3.8, 7.0)(30:180:0.85);
		\draw[line width=0.5mm] (4.539, 7.425) -- (10.5, -2.3);
