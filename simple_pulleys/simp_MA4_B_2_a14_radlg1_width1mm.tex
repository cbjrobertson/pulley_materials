...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.45, 15) -- (-2.935, 10.405);
		\centerarc[line width=1mm](-2, 9.8)(135:180:1.1);
		\draw[line width=1mm] (-3.1, 9.8) -- (-3.1, 4.2);
		\centerarc[line width=1mm](-2, 4.2)(180:270:1.1);
		\draw[line width=1mm](-2, 3.1) -- (1, 3.1);
		\centerarc[line width=1mm](1, 4.2)(270:360:1.1);
		\draw[line width=1mm] (2.1, 4.2) -- (1.9, 9.8);
		\centerarc[line width=1mm](3, 9.8)(-20:180:1.1);
		\draw[line width=1mm](4.067, 9.58) -- (2.9, 4.31);
		\centerarc[line width=1mm](4, 4.2)(160:360:1.1);
		\draw[line width=1mm](5.1, 4.2) -- (5.0, 14);
