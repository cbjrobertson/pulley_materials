...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](-0.5, -2) -- (-2.169, 3.587);
		\centerarc[line width=1mm](-2, 2.5)(180:210:1.1);
		\draw[line width=1mm](-3.1, 2.5) -- (-3.1, 8.0);
		\centerarc[line width=1mm](-2, 8.0)(90:180:1.1);
		
		\draw[line width=1mm](-2, 9.1) -- (1, 9.1);
		...
		\draw[line width=1mm](4.2, 0.5) -- (5.4, 8.0);
