...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (0.45, 15) -- (-2.51, 10.13);
		\centerarc[line width=0.75mm](-2, 9.8)(135:180:0.6);
		\draw[line width=0.75mm] (-2.6, 9.8) -- (-2.6, 4.2);
		\centerarc[line width=0.75mm](-2, 4.2)(180:270:0.6);
		\draw[line width=0.75mm](-2, 3.6) -- (1, 3.6);
		\centerarc[line width=0.75mm](1, 4.2)(270:360:0.6);
		\draw[line width=0.75mm] (1.6, 4.2) -- (2.4, 9.8);
		\centerarc[line width=0.75mm](3, 9.8)(-20:180:0.6);
		\draw[line width=0.75mm](3.582, 9.68) -- (3.4, 4.26);
		\centerarc[line width=0.75mm](4, 4.2)(160:360:0.6);
