...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (-0.25, 4.8) -- (0.3, 9.4);
		\draw[line width=1mm, fill=black](0.2, 8.8) rectangle (0.4, 9.4);
		\draw[line width=1mm] (-1.55, -1.8) -- (0.547, 5.095);
		\centerarc[line width=1mm](-0.25, 4.8)(-20:170:0.85);
		\draw[line width=1mm] (0.097, 4.024) -- (1.164, 2.542);
		\centerarc[line width=1mm](0.75, 1.8)(160:380:0.85);
		\draw[line width=1mm] (1.396, 1.248) -- (0.3, 9.6);
		\draw[line width=1mm](0.75, 1.8) -- (1.25, -0.1);
		\centerarc[line width=1mm](1.15, 9.6)(0:180:0.85);
