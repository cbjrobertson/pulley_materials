...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](1.6, 1.26) -- (1.6, 7.0);
		\draw[line width=1mm] (1.0, 14) -- (1.0, 7.0);
		\centerarc[line width=1mm](1.6, 7.0)(180:360:0.6);
		\draw[line width=1mm](2.2, 7.0) -- (2.2, 9.8);
		\centerarc[line width=1mm](2.8, 9.8)(35:180:0.6);
		\draw[line width=1mm] (3.25, 10.2) -- (8.025, 4.5);
		\centerarc[line width=1mm](7.5, 4.2)(215:135:-0.6);
		\draw[line width=1mm](7.98, 3.84) -- (5.942, -1.76);
		\centerarc[line width=1mm](6.5, -2)(-30:100:-0.6);
		\draw[line width=1mm](6.5, -2.6) -- (10.5, -2.3);
