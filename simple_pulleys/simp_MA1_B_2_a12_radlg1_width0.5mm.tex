...
\begin{document}
	\begin{tikzpicture}
		...
		\centerarc[line width=0.5mm](3.5, 2.4)(180:300:1.1);
		\draw[line width=0.5mm](3.476, 1.3) -- (7.976, 3.7);
		\centerarc[line width=0.5mm](8, 4.8)(300:390:1.1);
		\draw[line width=0.5mm](8.994, 5.271) -- (7.05, 9.8);
