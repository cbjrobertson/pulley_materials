...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width = 0.75mm] (1.4, 9.0) -- (1.4, 1.2);
		\centerarc[line width = 0.75mm](2, 9.0)(0:180:0.6);
		\draw[line width = 0.75mm] (2.6, 9.0) -- (3.1, 4.8);
		\draw[line width = 0.75mm] (2.5, 4.8) -- (2.5, 1.2);
		\centerarc[line width = 0.75mm](3.1, 4.8)(0:180:0.6);
		\draw[line width = 0.75mm] (3.7, 4.8) -- (4.4, -1);
		\centerarc[line width = 0.75mm](5, -1)(180:340:0.6);
		\draw[line width=0.75mm](5.456, -0.61) -- (9.563, 7.408);
		\centerarc[line width = 0.75mm](9, 7.2)(-20:170:0.6);
		\draw[line width=0.75mm](9.245, 6.652) --  (8.35, -1.9);
