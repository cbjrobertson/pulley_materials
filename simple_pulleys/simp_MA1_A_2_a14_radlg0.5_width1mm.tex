...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.4, 11) -- (0.4, 7.0);
		\centerarc[line width=1mm](1, 11)(0:180:0.6);
		\draw[line width=1mm](1.6, 11) -- (1.9, 0);
		\centerarc[line width=1mm](2.5, 0)(180:360:0.6);
		\draw[line width=1mm](3.1, 0) -- (2.9, 11.2);
		\centerarc[line width=1mm](3.5, 11.2)(0:180:0.6);
		\draw[line width=1mm](4.1, 11.2) -- (4.1, -1.8);
