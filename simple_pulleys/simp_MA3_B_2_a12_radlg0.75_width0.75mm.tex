...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](-0.5, -2) -- (-2.131, 3.84);
		\centerarc[line width=0.75mm](-2, 3.0)(180:210:0.85);
		\draw[line width=0.75mm](-2.85, 3.0) -- (-2.85, 9.6);
		\centerarc[line width=0.75mm](-2, 9.6)(90:180:0.85);
		
		\draw[line width=0.75mm](-2, 10.45) -- (1, 10.45);
		\centerarc[line width=0.75mm](1, 9.6)(0:90:0.85);
		\draw[line width=0.75mm](1.85, 9.6) -- (1.85, 3.0);
		\centerarc[line width=0.75mm](2.7, 3.0)(180:370:0.85);
		\draw[line width=0.75mm] (3.55, 2.99) -- (3.45, 9.6);
		\centerarc[line width=0.75mm](4.3, 9.6)(0:180:0.85);
		\draw[line width=0.75mm](4.2, 0.5) -- (5.15, 9.6);
