...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](-0.7, -1.9) -- (-0.1, 8.5);
		\centerarc[line width=1mm](1, 8.5)(0:180:1.1);
		\draw[line width=1mm](2.1, 8.5) -- (1.6, 2.5);
		\centerarc[line width=1mm](2.7, 2.5)(180:370:1.1);
		\draw[line width=1mm] (3.8, 2.49) -- (3.2, 8.5);
		\centerarc[line width=1mm](4.3, 8.5)(0:180:1.1);
		\draw[line width=1mm](4.2, 0.4) -- (5.4, 8.5);
