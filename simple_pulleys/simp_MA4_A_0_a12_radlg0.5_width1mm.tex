...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](1.6, 1.08) -- (2.1, 6.0);
		\draw[line width=1mm] (1.5, 12) -- (1.5, 6.0);
		\centerarc[line width=1mm](2.1, 6.0)(180:360:0.6);
		\draw[line width=1mm](2.7, 6.0) -- (2.7, 8.4);
		\centerarc[line width=1mm](3.3, 8.4)(30:180:0.6);
		\draw[line width=1mm] (3.822, 8.7) -- (10.5, -2.3);
