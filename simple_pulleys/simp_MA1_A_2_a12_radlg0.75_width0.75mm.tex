...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (0.15, 9) -- (0.15, 6.0);
		\centerarc[line width=0.75mm](1, 9)(0:180:0.85);
		\draw[line width=0.75mm](1.85, 9) -- (1.65, 0);
		\centerarc[line width=0.75mm](2.5, 0)(180:360:0.85);
		\draw[line width=0.75mm](3.35, 0) -- (2.65, 9.6);
		\centerarc[line width=0.75mm](3.5, 9.6)(0:180:0.85);
		\draw[line width=0.75mm](4.35, 9.6) -- (4.1, -1.8);
