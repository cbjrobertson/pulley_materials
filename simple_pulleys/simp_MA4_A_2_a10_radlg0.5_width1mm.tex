...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.4, 10) -- (0.4, 0.9);
		\centerarc[line width=1mm](1, 0.9)(180:360:0.6);
		\draw[line width=1mm](1.6, 0.9) -- (1.6, 5.0);
		\draw[line width=1mm] (1.0, 10) -- (1.0, 5.0);
		\centerarc[line width=1mm](1.6, 5.0)(180:360:0.6);
		\draw[line width=1mm](2.2, 5.0) -- (2.2, 7.0);
		\centerarc[line width=1mm](2.8, 7.0)(35:180:0.6);
		\draw[line width=1mm] (3.25, 7.4) -- (8.025, 3.3);
		\centerarc[line width=1mm](7.5, 3.0)(215:135:-0.6);
		\draw[line width=1mm](7.98, 2.64) -- (5.942, -1.76);
