...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.35, 13) --  (-0.1, 3.6);
		\centerarc[line width=1mm](1, 3.6)(180:360:1.1);
		\draw[line width=1mm] (2.1, 3.6) -- (1.15, 8.4);
		\centerarc[line width=1mm](2.25, 8.4)(-20:180:1.1);
		\draw[line width=1mm](3.317, 8.18) -- (2.4, 3.71);
		\centerarc[line width=1mm](3.5, 3.6)(160:360:1.1);
