...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.4, 10) -- (0.4, 6.0);
		\centerarc[line width=1mm](1, 10)(0:180:0.6);
		\draw[line width=1mm](1.6, 10) -- (1.9, 2.4);
		\centerarc[line width=1mm](2.5, 2.4)(180:270:0.6);
		\draw[line width=1mm](3.09, 2.294) -- (6.1, 1.3);
