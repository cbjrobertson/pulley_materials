...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.9, 14) -- (0.9, 4.2);
		\centerarc[line width=1mm](2, 4.2)(180:330:1.1);
		\draw[line width=1mm](0.91, 4.055) -- (3.831, 8.013);
		\centerarc[line width=1mm](4, 9.1)(390:325:1.1);
		\draw[line width=1mm](4.994, 9.571) -- (2.994, 14.521);
		\centerarc[line width=1mm](2, 14.05)(30:90:1.1);
		\draw[line width=1mm](2, 15.15) -- (-1, 15.15);
