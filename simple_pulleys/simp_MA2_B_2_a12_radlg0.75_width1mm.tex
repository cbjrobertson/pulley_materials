...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (1.15, 12) -- (1.15, 4.2);
		\centerarc[line width=1mm](2, 4.2)(180:360:0.85);
		\draw[line width=1mm](2.85, 4.2) -- (3.15, 7.8);
		\centerarc[line width=1mm](4, 7.8)(110:180:0.85);
		\draw[line width=1mm](3.151, 7.763) -- (6.981, 11.2);
		\centerarc[line width=1mm](7, 12.05)(-60:50:0.85);
		\draw[line width=1mm](7.82, 11.827) -- (2.191, 13.741);
		\centerarc[line width=1mm](3, 14)(60:120:0.85);
		\draw[line width=1mm](3.692, 14.494) -- (-1.2, 13.15);
