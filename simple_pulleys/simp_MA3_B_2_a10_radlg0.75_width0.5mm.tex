...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm](-0.5, -2) -- (-2.131, 3.34);
		\centerarc[line width=0.5mm](-2, 2.5)(180:210:0.85);
		\draw[line width=0.5mm](-2.85, 2.5) -- (-2.85, 8.0);
		\centerarc[line width=0.5mm](-2, 8.0)(90:180:0.85);
		
		\draw[line width=0.5mm](-2, 8.85) -- (1, 8.85);
		\centerarc[line width=0.5mm](1, 8.0)(0:90:0.85);
		\draw[line width=0.5mm](1.85, 8.0) -- (1.85, 2.5);
		\centerarc[line width=0.5mm](2.7, 2.5)(180:370:0.85);
		\draw[line width=0.5mm] (3.55, 2.49) -- (3.45, 8.0);
		\centerarc[line width=0.5mm](4.3, 8.0)(0:180:0.85);
		\draw[line width=0.5mm](4.2, 0.5) -- (5.15, 8.0);
