...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.35, 15) --  (-0.1, 4.2);
		\centerarc[line width=1mm](1, 4.2)(180:360:1.1);
		\draw[line width=1mm] (2.1, 4.2) -- (1.15, 9.8);
		\centerarc[line width=1mm](2.25, 9.8)(-20:180:1.1);
		\draw[line width=1mm](3.317, 9.58) -- (2.4, 4.31);
		\centerarc[line width=1mm](3.5, 4.2)(160:360:1.1);
