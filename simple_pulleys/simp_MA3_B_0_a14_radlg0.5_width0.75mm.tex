...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](-0.7, -1.9) -- (0.4, 11.9);
		\centerarc[line width=0.75mm](1, 11.9)(0:180:0.6);
		\draw[line width=0.75mm](1.6, 11.9) -- (2.1, 3.5);
		\centerarc[line width=0.75mm](2.7, 3.5)(180:370:0.6);
		\draw[line width=0.75mm] (3.3, 3.49) -- (3.7, 11.9);
		\centerarc[line width=0.75mm](4.3, 11.9)(0:180:0.6);
		\draw[line width=0.75mm](4.2, 0.4) -- (4.9, 11.9);
