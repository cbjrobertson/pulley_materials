...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.2, 5) -- (-0.15, 8.5);
		\centerarc[line width=1mm](-1, 8.5)(0:200:0.85);
		\draw[line width=1mm] (-1.85, 8.373) -- (-0.595, 4.677);
		\centerarc[line width=1mm](0.2, 5)(200:360:0.85);
		\draw[line width=1mm](1.05, 5) -- (1.45, 8.5);
		\centerarc[line width=1mm](2.3, 8.5)(0:180:0.85);
		\draw[line width=1mm] (3.15, 8.5) -- (3.65, 5);
		\centerarc[line width=1mm](4.5, 5)(180:360:0.85);
		\draw[line width=1mm] (5.35, 5) -- (5.85, 8.5);
		\centerarc[line width=1mm](6.7, 8.5)(30:180:0.85);
		\draw[line width=1mm](7.431, 8.934) -- (8.948, 6.434);
		\centerarc[line width=1mm](8.2, 6)(160:211:-0.85);
		\draw[line width=1mm](9.03, 5.814) -- (7.452, -0.592);
		\centerarc[line width=1mm](8.2, -1.0)(150:280:0.85);
		\draw[line width=1mm](7.416, -1.33) -- (11, -1.8);
