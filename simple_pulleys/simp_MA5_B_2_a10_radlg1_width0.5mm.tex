...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (-0.9, -1.0) -- (-2.1, 4.0);
		\draw[line width=0.5mm] (-1, 4.0) -- (0.1, 7.8);
		\draw[line width=0.5mm, fill=black](0.0, 7.2) rectangle (0.2, 7.8);
		\centerarc[line width=0.5mm](-1, 4.0)(-20:180:1.1);
		\draw[line width=0.5mm] (-0.551, 2.996) -- (1.036, 2.46);
		\centerarc[line width=0.5mm](0.5, 1.5)(160:380:1.1);
		\draw[line width=0.5mm] (1.336, 0.785) -- (0.1, 8.0);
		\draw[line width=0.5mm](0.5, 1.5) -- (0.75, 0.0);
		\centerarc[line width=0.5mm](1.2, 8.0)(0:180:1.1);
		\draw[line width=0.5mm] (2.3, 8.0) -- (1.75, 0.0);
