...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](-0.7, -1.9) --  (-2.35, 11.1);
		\centerarc[line width=1mm](-1.5, 11.1)(90:180:0.85);
		\draw[line width=1mm](-1.5, 11.95) -- (1, 12.05);
		...
		\draw[line width=1mm](4.2, 0.4) -- (5.15, 11.2);
