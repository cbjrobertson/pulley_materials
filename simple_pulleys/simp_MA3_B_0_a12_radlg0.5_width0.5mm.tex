...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm](-0.7, -1.9) -- (0.4, 10.2);
		\centerarc[line width=0.5mm](1, 10.2)(0:180:0.6);
		\draw[line width=0.5mm](1.6, 10.2) -- (2.1, 3.0);
		\centerarc[line width=0.5mm](2.7, 3.0)(180:370:0.6);
		\draw[line width=0.5mm] (3.3, 2.99) -- (3.7, 10.2);
		\centerarc[line width=0.5mm](4.3, 10.2)(0:180:0.6);
		\draw[line width=0.5mm](4.2, 0.4) -- (4.9, 10.2);
