...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (0.9, 14) -- (0.9, 4.9);
		\centerarc[line width=0.75mm](2, 4.9)(180:360:1.1);
		\draw[line width=0.75mm](3.1, 4.9) -- (2.9, 9.1);
		\centerarc[line width=0.75mm](4, 9.1)(110:180:1.1);
		\draw[line width=0.75mm](2.901, 9.052) -- (6.976, 12.95);
		\centerarc[line width=0.75mm](7, 14.05)(-60:50:1.1);
		\draw[line width=0.75mm](8.062, 13.762) -- (1.953, 15.665);
		\centerarc[line width=0.75mm](3, 16)(60:120:1.1);
		\draw[line width=0.75mm](3.895, 16.639) -- (-1.2, 15.15);
