...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (0.4, 7) -- (0.4, 5.0);
		\centerarc[line width=0.75mm](1, 7)(0:180:0.6);
		\draw[line width=0.75mm](1.6, 7) -- (1.9, 0);
		\centerarc[line width=0.75mm](2.5, 0)(180:360:0.6);
		\draw[line width=0.75mm](3.1, 0) -- (2.9, 8.0);
		\centerarc[line width=0.75mm](3.5, 8.0)(0:180:0.6);
		\draw[line width=0.75mm](4.1, 8.0) -- (4.1, -1.8);
