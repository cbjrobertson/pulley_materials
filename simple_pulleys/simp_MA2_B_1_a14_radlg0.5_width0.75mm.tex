...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (1.4, 14) -- (1.4, 4.2);
		\centerarc[line width=0.75mm](2, 4.2)(180:330:0.6);
		\draw[line width=0.75mm](1.405, 4.121) -- (3.908, 8.507);
		\centerarc[line width=0.75mm](4, 9.1)(390:325:0.6);
		\draw[line width=0.75mm](4.542, 9.357) -- (2.542, 14.307);
		\centerarc[line width=0.75mm](2, 14.05)(30:90:0.6);
