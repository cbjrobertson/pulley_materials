...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](3.8, 11.2) -- (5.4, -1);
		\centerarc[line width=0.75mm](6, -1)(180:360:0.6);
		\draw[line width=0.75mm](6.6, -1) -- (7.4, 2.8);
		\centerarc[line width=0.75mm](8, 2.8)(0:180:0.6);
		\draw[line width=0.75mm](8.6, 2.8) -- (9.1, -1.8);
