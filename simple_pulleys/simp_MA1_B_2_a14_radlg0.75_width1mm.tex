...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](-0.35, 5.1) --  (0.15, 5.6) -- (0.65, 5.1);
		\draw[fill=black!50] (-0.85, 5.1) rectangle (1.15, 3.1);
		
		\draw[line width=1mm](0.15, 12) -- (0.15, 5.6);
		\centerarc[line width=1mm](1, 12)(180:0:0.85)
		\draw[line width=1mm](1.85, 12) -- (2.65, 2.8);
		\centerarc[line width=1mm](3.5, 2.8)(180:300:0.85);
		\draw[line width=1mm](3.481, 1.95) -- (7.981, 4.75);
		\centerarc[line width=1mm](8, 5.6)(300:390:0.85);
		\draw[line width=1mm](8.768, 5.964) -- (7.05, 11.8);
