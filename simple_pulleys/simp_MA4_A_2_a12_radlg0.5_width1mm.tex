...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.4, 12) -- (0.4, 1.08);
		\centerarc[line width=1mm](1, 1.08)(180:360:0.6);
		\draw[line width=1mm](1.6, 1.08) -- (1.6, 6.0);
		\draw[line width=1mm] (1.0, 12) -- (1.0, 6.0);
		\centerarc[line width=1mm](1.6, 6.0)(180:360:0.6);
		\draw[line width=1mm](2.2, 6.0) -- (2.2, 8.4);
		\centerarc[line width=1mm](2.8, 8.4)(35:180:0.6);
		\draw[line width=1mm] (3.25, 8.8) -- (8.025, 3.9);
		\centerarc[line width=1mm](7.5, 3.6)(215:135:-0.6);
		\draw[line width=1mm](7.98, 3.24) -- (5.942, -1.76);
