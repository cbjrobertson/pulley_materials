...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.15, 14) -- (0.15, 4.2);
		\centerarc[line width=1mm](1, 4.2)(180:360:0.85);
		\draw[line width=1mm](1.85, 4.2) -- (2.35, 11.2);
		\centerarc[line width=1mm](3.2, 11.2)(0:180:0.85);
		\draw[line width=1mm](4.05, 11.2) -- (5.15, -1);
		\centerarc[line width=1mm](6, -1)(180:360:0.85);
		\draw[line width=1mm](6.85, -1) -- (7.15, 2.8);
		\centerarc[line width=1mm](8, 2.8)(0:180:0.85);
		\draw[line width=1mm](8.85, 2.8) -- (9.1, -1.8);
