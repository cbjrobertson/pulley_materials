...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (0.35, 11) --  (0.4, 3.0);
		\centerarc[line width=0.5mm](1, 3.0)(180:360:0.6);
		\draw[line width=0.5mm] (1.6, 3.0) -- (1.65, 7.0);
		\centerarc[line width=0.5mm](2.25, 7.0)(-20:180:0.6);
		\draw[line width=0.5mm](2.832, 6.88) -- (2.9, 3.06);
		\centerarc[line width=0.5mm](3.5, 3.0)(160:360:0.6);
		\draw[line width=0.5mm](4.1, 3.0) -- (4.0, 10);
