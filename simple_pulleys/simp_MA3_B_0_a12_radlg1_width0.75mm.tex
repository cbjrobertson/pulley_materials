...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](-0.7, -1.9) -- (-0.1, 10.2);
		\centerarc[line width=0.75mm](1, 10.2)(0:180:1.1);
		\draw[line width=0.75mm](2.1, 10.2) -- (1.6, 3.0);
		\centerarc[line width=0.75mm](2.7, 3.0)(180:370:1.1);
		\draw[line width=0.75mm] (3.8, 2.99) -- (3.2, 10.2);
		\centerarc[line width=0.75mm](4.3, 10.2)(0:180:1.1);
		\draw[line width=0.75mm](4.2, 0.4) -- (5.4, 10.2);
