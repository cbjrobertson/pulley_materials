...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](-0.7, -1.9) --  (-2.6, 7.9);
		\centerarc[line width=0.75mm](-1.5, 7.9)(90:180:1.1);
		\draw[line width=0.75mm](-1.5, 9.0) -- (1, 9.1);
		...
		\draw[line width=0.75mm](4.2, 0.4) -- (5.4, 8.0);
