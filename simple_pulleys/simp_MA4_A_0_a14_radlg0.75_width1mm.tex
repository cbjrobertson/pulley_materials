...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](1.85, 1.26) -- (2.1, 7.0);
		\draw[line width=1mm] (1.25, 14) -- (1.25, 7.0);
		\centerarc[line width=1mm](2.1, 7.0)(180:360:0.85);
		\draw[line width=1mm](2.95, 7.0) -- (2.95, 9.8);
		\centerarc[line width=1mm](3.8, 9.8)(30:180:0.85);
		\draw[line width=1mm] (4.539, 10.225) -- (10.5, -2.3);
