...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (1.4, 14) -- (1.4, 4.9);
		\centerarc[line width=1mm](2, 4.9)(180:360:0.6);
		\draw[line width=1mm](2.6, 4.9) -- (3.4, 9.1);
		\centerarc[line width=1mm](4, 9.1)(110:180:0.6);
		\draw[line width=1mm](3.401, 9.074) -- (6.987, 13.45);
		\centerarc[line width=1mm](7, 14.05)(-60:50:0.6);
		\draw[line width=1mm](7.579, 13.893) -- (2.429, 15.817);
		\centerarc[line width=1mm](3, 16)(60:120:0.6);
		\draw[line width=1mm](3.488, 16.349) -- (-1.2, 15.15);
