...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](1.85, 0.9) -- (1.85, 5.0);
		\draw[line width=1mm] (1.0, 10) -- (1.0, 5.0);
		\centerarc[line width=1mm](1.85, 5.0)(180:360:0.85);
		\draw[line width=1mm](2.7, 5.0) -- (2.7, 7.0);
		\centerarc[line width=1mm](3.55, 7.0)(35:180:0.85);
		\draw[line width=1mm] (4.187, 7.567) -- (8.244, 3.425);
		\centerarc[line width=1mm](7.5, 3.0)(215:135:-0.85);
		\draw[line width=1mm](8.18, 2.49) -- (5.71, -1.66);
