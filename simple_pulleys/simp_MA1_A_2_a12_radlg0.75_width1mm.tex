...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (-0.35, 5.5) -- (0.15, 6.0) -- (0.65, 5.5);
		\draw[fill=black!50] (-0.85, 5.5) rectangle (1.15, 3.5);
		
		\draw[line width=1mm] (0.15, 9) -- (0.15, 6.0);
		\centerarc[line width=1mm](1, 9)(0:180:0.85);
		\draw[line width=1mm](1.85, 9) -- (1.65, 0);
		\centerarc[line width=1mm](2.5, 0)(180:360:0.85);
		\draw[line width=1mm](3.35, 0) -- (2.65, 9.6);
		\centerarc[line width=1mm](3.5, 9.6)(0:180:0.85);
		\draw[line width=1mm](4.35, 9.6) -- (4.1, -1.8);
