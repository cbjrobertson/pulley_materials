...
\begin{document}
	\begin{tikzpicture}
		...
		\centerarc[line width=0.5mm](3.5, 2.4)(180:300:0.6);
		\draw[line width=0.5mm](3.487, 1.8) -- (7.987, 4.2);
		\centerarc[line width=0.5mm](8, 4.8)(300:390:0.6);
		\draw[line width=0.5mm](8.542, 5.057) -- (7.05, 9.8);
