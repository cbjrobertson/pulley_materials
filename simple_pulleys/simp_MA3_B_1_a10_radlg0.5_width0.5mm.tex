...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm](-0.7, -1.9) --  (-2.1, 7.9);
		\centerarc[line width=0.5mm](-1.5, 7.9)(90:180:0.6);
		\draw[line width=0.5mm](-1.5, 8.5) -- (1, 8.6);
		...
		\draw[line width=0.5mm](4.2, 0.4) -- (4.9, 8.0);
