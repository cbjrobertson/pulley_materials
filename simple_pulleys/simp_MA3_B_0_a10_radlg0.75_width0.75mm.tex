...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](-0.7, -1.9) -- (0.15, 8.5);
		\centerarc[line width=0.75mm](1, 8.5)(0:180:0.85);
		\draw[line width=0.75mm](1.85, 8.5) -- (1.85, 2.5);
		\centerarc[line width=0.75mm](2.7, 2.5)(180:370:0.85);
		\draw[line width=0.75mm] (3.55, 2.49) -- (3.45, 8.5);
		\centerarc[line width=0.75mm](4.3, 8.5)(0:180:0.85);
		\draw[line width=0.75mm](4.2, 0.4) -- (5.15, 8.5);
