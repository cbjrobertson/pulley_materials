...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (-5.05, -1.8) -- (-4.35, 8.0);
		\centerarc[line width=0.75mm](-3.5, 8.0)(0:180:0.85);
		\draw[line width=0.75mm] (-2.65, 8.0) -- (-2.85, -1.0);
		\centerarc[line width=0.75mm](-2, -1.0)(180:360:0.85);
		\draw[line width=0.75mm] (-1.15, -1.0) -- (-1.85, 4.0);
		\draw[line width=0.75mm] (-1, 4.0) -- (0.35, 7.8);
		\draw[line width=0.75mm, fill=black](0.25, 7.2) rectangle (0.45, 7.8);
		\centerarc[line width=0.75mm](-1, 4.0)(-20:180:0.85);
		\draw[line width=0.75mm] (-0.653, 3.224) -- (0.914, 2.242);
		\centerarc[line width=0.75mm](0.5, 1.5)(160:380:0.85);
		\draw[line width=0.75mm] (1.146, 0.948) -- (0.35, 8.0);
		\draw[line width=0.75mm](0.5, 1.5) -- (0.75, 0.0);
		\centerarc[line width=0.75mm](1.2, 8.0)(0:180:0.85);
		\draw[line width=0.75mm] (2.05, 8.0) -- (1.75, 0.0);
