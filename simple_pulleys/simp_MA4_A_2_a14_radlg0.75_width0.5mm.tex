...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (0.15, 14) -- (0.15, 1.26);
		\centerarc[line width=0.5mm](1, 1.26)(180:360:0.85);
		\draw[line width=0.5mm](1.85, 1.26) -- (1.85, 7.0);
		\draw[line width=0.5mm] (1.0, 14) -- (1.0, 7.0);
		\centerarc[line width=0.5mm](1.85, 7.0)(180:360:0.85);
		\draw[line width=0.5mm](2.7, 7.0) -- (2.7, 9.8);
		\centerarc[line width=0.5mm](3.55, 9.8)(35:180:0.85);
		\draw[line width=0.5mm] (4.187, 10.367) -- (8.244, 4.625);
		\centerarc[line width=0.5mm](7.5, 4.2)(215:135:-0.85);
		\draw[line width=0.5mm](8.18, 3.69) -- (5.71, -1.66);
