...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (0.45, 13) -- (-2.935, 9.005);
		\centerarc[line width=0.75mm](-2, 8.4)(135:180:1.1);
		\draw[line width=0.75mm] (-3.1, 8.4) -- (-3.1, 3.6);
		\centerarc[line width=0.75mm](-2, 3.6)(180:270:1.1);
		\draw[line width=0.75mm](-2, 2.5) -- (1, 2.5);
		\centerarc[line width=0.75mm](1, 3.6)(270:360:1.1);
		\draw[line width=0.75mm] (2.1, 3.6) -- (1.9, 8.4);
		\centerarc[line width=0.75mm](3, 8.4)(-20:180:1.1);
		\draw[line width=0.75mm](4.067, 8.18) -- (2.9, 3.71);
		\centerarc[line width=0.75mm](4, 3.6)(160:360:1.1);
		\draw[line width=0.75mm](5.1, 3.6) -- (5.0, 12);
