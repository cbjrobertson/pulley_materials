...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (-5.05, -1.8) -- (-4.6, 11.2);
		\centerarc[line width=0.5mm](-3.5, 11.2)(0:180:1.1);
		\draw[line width=0.5mm] (-2.4, 11.2) -- (-3.1, -1.4);
		\centerarc[line width=0.5mm](-2, -1.4)(180:360:1.1);
		\draw[line width=0.5mm] (-0.9, -1.4) -- (-2.1, 5.6);
		\draw[line width=0.5mm] (-1, 5.6) -- (0.1, 11.0);
		\draw[line width=0.5mm, fill=black](0.0, 10.4) rectangle (0.2, 11.0);
		\centerarc[line width=0.5mm](-1, 5.6)(-20:180:1.1);
		\draw[line width=0.5mm] (-0.551, 4.596) -- (1.036, 3.06);
		\centerarc[line width=0.5mm](0.5, 2.1)(160:380:1.1);
		\draw[line width=0.5mm] (1.336, 1.385) -- (0.1, 11.2);
		\draw[line width=0.5mm](0.5, 2.1) -- (0.75, -0.2);
		\centerarc[line width=0.5mm](1.2, 11.2)(0:180:1.1);
		\draw[line width=0.5mm] (2.3, 11.2) -- (1.75, -0.2);
