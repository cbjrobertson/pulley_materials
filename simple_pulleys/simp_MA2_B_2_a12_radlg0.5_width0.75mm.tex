...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (1.4, 12) -- (1.4, 4.2);
		\centerarc[line width=0.75mm](2, 4.2)(180:360:0.6);
		\draw[line width=0.75mm](2.6, 4.2) -- (3.4, 7.8);
		\centerarc[line width=0.75mm](4, 7.8)(110:180:0.6);
		\draw[line width=0.75mm](3.401, 7.774) -- (6.987, 11.45);
		\centerarc[line width=0.75mm](7, 12.05)(-60:50:0.6);
		\draw[line width=0.75mm](7.579, 11.893) -- (2.429, 13.817);
		\centerarc[line width=0.75mm](3, 14)(60:120:0.6);
		\draw[line width=0.75mm](3.488, 14.349) -- (-1.2, 13.15);
