...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (-0.1, 12) -- (-0.1, 1.08);
		\centerarc[line width=0.75mm](1, 1.08)(180:360:1.1);
		\draw[line width=0.75mm](2.1, 1.08) -- (2.1, 6.0);
		\draw[line width=0.75mm] (1.0, 12) -- (1.0, 6.0);
		\centerarc[line width=0.75mm](2.1, 6.0)(180:360:1.1);
		\draw[line width=0.75mm](3.2, 6.0) -- (3.2, 8.4);
		\centerarc[line width=0.75mm](4.3, 8.4)(35:180:1.1);
		\draw[line width=0.75mm] (5.125, 9.133) -- (8.463, 4.15);
		\centerarc[line width=0.75mm](7.5, 3.6)(215:135:-1.1);
		\draw[line width=0.75mm](8.38, 2.94) -- (5.477, -1.56);
