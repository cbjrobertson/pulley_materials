...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](-0.6, 3.5) --  (-0.1, 4.0) -- (0.4, 3.5);
		\draw[fill=black!50] (-1.1, 3.5) rectangle (0.9, 1.5);
		
		\draw[line width=0.75mm](-0.1, 8) -- (-0.1, 4.0);
		\centerarc[line width=0.75mm](1, 8)(180:0:1.1)
		\draw[line width=0.75mm](2.1, 8) -- (2.4, 2.0);
		\centerarc[line width=0.75mm](3.5, 2.0)(180:300:1.1);
		\draw[line width=0.75mm](3.476, 0.9) -- (7.976, 2.9);
		\centerarc[line width=0.75mm](8, 4.0)(300:390:1.1);
		\draw[line width=0.75mm](8.994, 4.471) -- (7.05, 7.8);
