...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (1.15, 10) -- (1.15, 3.0);
		\centerarc[line width=0.5mm](2, 3.0)(180:330:0.85);
		\draw[line width=0.5mm](1.158, 2.888) -- (3.869, 5.66);
		\centerarc[line width=0.5mm](4, 6.5)(390:325:0.85);
		\draw[line width=0.5mm](4.768, 6.864) -- (2.768, 10.414);
		\centerarc[line width=0.5mm](2, 10.05)(30:90:0.85);
		\draw[line width=0.5mm](2, 10.9) -- (-1, 11.15);
