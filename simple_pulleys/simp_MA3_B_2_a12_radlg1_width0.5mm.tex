...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm](-0.5, -2) -- (-2.169, 4.087);
		\centerarc[line width=0.5mm](-2, 3.0)(180:210:1.1);
		\draw[line width=0.5mm](-3.1, 3.0) -- (-3.1, 9.6);
		\centerarc[line width=0.5mm](-2, 9.6)(90:180:1.1);
		
		\draw[line width=0.5mm](-2, 10.7) -- (1, 10.7);
		...
		\draw[line width=0.5mm](4.2, 0.5) -- (5.4, 9.6);
