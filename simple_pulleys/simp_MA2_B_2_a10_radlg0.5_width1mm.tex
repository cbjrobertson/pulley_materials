...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (1.4, 10) -- (1.4, 3.5);
		\centerarc[line width=1mm](2, 3.5)(180:360:0.6);
		\draw[line width=1mm](2.6, 3.5) -- (3.4, 6.5);
		\centerarc[line width=1mm](4, 6.5)(110:180:0.6);
		\draw[line width=1mm](3.401, 6.474) -- (6.987, 9.45);
		\centerarc[line width=1mm](7, 10.05)(-60:50:0.6);
		\draw[line width=1mm](7.579, 9.893) -- (2.429, 11.817);
		\centerarc[line width=1mm](3, 12)(60:120:0.6);
		\draw[line width=1mm](3.488, 12.349) -- (-1.2, 11.15);
