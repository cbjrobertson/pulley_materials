...
\begin{document}
	\begin{tikzpicture}
		...
		\centerarc[line width=1mm](3.5, 2.4)(180:300:0.85);
		\draw[line width=1mm](3.481, 1.55) -- (7.981, 3.95);
		\centerarc[line width=1mm](8, 4.8)(300:390:0.85);
		\draw[line width=1mm](8.768, 5.164) -- (7.05, 9.8);
