...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (0.15, 10) -- (0.15, 3.0);
		\centerarc[line width=0.5mm](1, 3.0)(180:360:0.85);
		\draw[line width=0.5mm](1.85, 3.0) -- (2.35, 8.0);
		\centerarc[line width=0.5mm](3.2, 8.0)(0:180:0.85);
		\draw[line width=0.5mm](4.05, 8.0) -- (5.15, -1);
		\centerarc[line width=0.5mm](6, -1)(180:360:0.85);
		\draw[line width=0.5mm](6.85, -1) -- (7.15, 2.0);
		\centerarc[line width=0.5mm](8, 2.0)(0:180:0.85);
		\draw[line width=0.5mm](8.85, 2.0) -- (9.1, -1.8);
