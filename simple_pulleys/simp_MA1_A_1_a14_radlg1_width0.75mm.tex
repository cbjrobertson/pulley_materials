...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (-0.1, 12) -- (-0.1, 7.0);
		\centerarc[line width=0.75mm](1, 12)(0:180:1.1);
		\draw[line width=0.75mm](2.1, 12) -- (1.4, 2.8);
		\centerarc[line width=0.75mm](2.5, 2.8)(180:270:1.1);
		\draw[line width=0.75mm](3.582, 2.606) -- (6.1, 1.3);
