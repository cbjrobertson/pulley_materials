...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width = 0.5mm] (1.15, 9.6) -- (1.15, 1.2);
		\centerarc[line width = 0.5mm](2, 9.6)(0:180:0.85);
		\draw[line width = 0.5mm] (2.85, 9.6) -- (3.1, 4.8);
		\draw[line width = 0.5mm] (2.25, 4.8) -- (2.25, 1.2);
		\centerarc[line width = 0.5mm](3.1, 4.8)(0:180:0.85);
		\draw[line width = 0.5mm] (3.95, 4.8) -- (4.6, -1.9);
