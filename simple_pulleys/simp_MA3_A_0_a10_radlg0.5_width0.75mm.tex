...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width = 0.75mm] (1.4, 8.0) -- (1.4, 1.0);
		\centerarc[line width = 0.75mm](2, 8.0)(0:180:0.6);
		\draw[line width = 0.75mm] (2.6, 8.0) -- (3.1, 4.0);
		\draw[line width = 0.75mm] (2.5, 4.0) -- (2.5, 1.0);
		\centerarc[line width = 0.75mm](3.1, 4.0)(0:180:0.6);
		\draw[line width = 0.75mm] (3.7, 4.0) -- (4.6, -1.9);
