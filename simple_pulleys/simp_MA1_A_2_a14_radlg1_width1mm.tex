...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (-0.1, 11) -- (-0.1, 7.0);
		\centerarc[line width=1mm](1, 11)(0:180:1.1);
		\draw[line width=1mm](2.1, 11) -- (1.4, 0);
		\centerarc[line width=1mm](2.5, 0)(180:360:1.1);
		\draw[line width=1mm](3.6, 0) -- (2.4, 11.2);
		\centerarc[line width=1mm](3.5, 11.2)(0:180:1.1);
		\draw[line width=1mm](4.6, 11.2) -- (4.1, -1.8);
