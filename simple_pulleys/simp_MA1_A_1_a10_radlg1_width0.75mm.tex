...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (-0.1, 8) -- (-0.1, 5.0);
		\centerarc[line width=0.75mm](1, 8)(0:180:1.1);
		\draw[line width=0.75mm](2.1, 8) -- (1.4, 2.0);
		\centerarc[line width=0.75mm](2.5, 2.0)(180:270:1.1);
		\draw[line width=0.75mm](3.582, 1.806) -- (6.1, 1.3);
