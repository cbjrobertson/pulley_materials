...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (3, 12) -- (3, 14);
		
		\draw (2, 3.5) -- (2, 1.5) -- (1.5, 1.0) -- (2.5, 1.0) -- (2, 1.5);
		\draw[fill=black!50] (0.95, 1.0) rectangle (3.05, -1.0);
		
		\draw[line width=1mm] (1.15, 10) -- (1.15, 3.5);
		\centerarc[line width=1mm](2, 3.5)(180:360:0.85);
		\draw[line width=1mm](2.85, 3.5) -- (3.15, 6.5);
		\centerarc[line width=1mm](4, 6.5)(110:180:0.85);
		\draw[line width=1mm](3.151, 6.463) -- (6.981, 9.2);
		\centerarc[line width=1mm](7, 10.05)(-60:50:0.85);
		\draw[line width=1mm](7.82, 9.827) -- (2.191, 11.741);
		\centerarc[line width=1mm](3, 12)(60:120:0.85);
		\draw[line width=1mm](3.692, 12.494) -- (-1.2, 11.15);
