...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.4, 10) -- (0.4, 3.0);
		\centerarc[line width=1mm](1, 3.0)(180:360:0.6);
		\draw[line width=1mm](1.6, 3.0) -- (2.6, 8.0);
		\centerarc[line width=1mm](3.2, 8.0)(0:180:0.6);
		\draw[line width=1mm](3.8, 8.0) -- (5.4, -1);
		\centerarc[line width=1mm](6, -1)(180:360:0.6);
		\draw[line width=1mm](6.6, -1) -- (7.4, 2.0);
		\centerarc[line width=1mm](8, 2.0)(0:180:0.6);
		\draw[line width=1mm](8.6, 2.0) -- (9.1, -1.8);
