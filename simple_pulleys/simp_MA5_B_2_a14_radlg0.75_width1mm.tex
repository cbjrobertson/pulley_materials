...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (-5.05, -1.8) -- (-4.35, 11.2);
		\centerarc[line width=1mm](-3.5, 11.2)(0:180:0.85);
		\draw[line width=1mm] (-2.65, 11.2) -- (-2.85, -1.4);
		\centerarc[line width=1mm](-2, -1.4)(180:360:0.85);
		\draw[line width=1mm] (-1.15, -1.4) -- (-1.85, 5.6);
		\draw[line width=1mm] (-1, 5.6) -- (0.35, 11.0);
		\draw[line width=1mm, fill=black](0.25, 10.4) rectangle (0.45, 11.0);
		\centerarc[line width=1mm](-1, 5.6)(-20:180:0.85);
		\draw[line width=1mm] (-0.653, 4.824) -- (0.914, 2.842);
		\centerarc[line width=1mm](0.5, 2.1)(160:380:0.85);
		\draw[line width=1mm] (1.146, 1.547) -- (0.35, 11.2);
		\draw[line width=1mm](0.5, 2.1) -- (0.75, -0.2);
		\centerarc[line width=1mm](1.2, 11.2)(0:180:0.85);
		\draw[line width=1mm] (2.05, 11.2) -- (1.75, -0.2);
