...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (-0.9, -1.2) -- (-2.1, 4.8);
		\draw[line width=0.5mm] (-1, 4.8) -- (0.1, 9.4);
		\draw[line width=0.5mm, fill=black](0.0, 8.8) rectangle (0.2, 9.4);
		\centerarc[line width=0.5mm](-1, 4.8)(-20:180:1.1);
		\draw[line width=0.5mm] (-0.551, 3.796) -- (1.036, 2.76);
		\centerarc[line width=0.5mm](0.5, 1.8)(160:380:1.1);
		\draw[line width=0.5mm] (1.336, 1.085) -- (0.1, 9.6);
		\draw[line width=0.5mm](0.5, 1.8) -- (0.75, -0.1);
		\centerarc[line width=0.5mm](1.2, 9.6)(0:180:1.1);
		\draw[line width=0.5mm] (2.3, 9.6) -- (1.75, -0.1);
