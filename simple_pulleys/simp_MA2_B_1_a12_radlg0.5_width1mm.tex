...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (1.4, 12) -- (1.4, 3.6);
		\centerarc[line width=1mm](2, 3.6)(180:330:0.6);
		\draw[line width=1mm](1.405, 3.521) -- (3.908, 7.207);
		\centerarc[line width=1mm](4, 7.8)(390:325:0.6);
		\draw[line width=1mm](4.542, 8.057) -- (2.542, 12.307);
		\centerarc[line width=1mm](2, 12.05)(30:90:0.6);
		\draw[line width=1mm](2, 12.65) -- (-1, 13.15);
