...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (-5.05, -1.8) -- (-4.1, 8.0);
		\centerarc[line width=0.5mm](-3.5, 8.0)(0:180:0.6);
		\draw[line width=0.5mm] (-2.9, 8.0) -- (-2.6, -1.0);
		\centerarc[line width=0.5mm](-2, -1.0)(180:360:0.6);
		\draw[line width=0.5mm] (-1.4, -1.0) -- (-1.6, 4.0);
		\draw[line width=0.5mm] (-1, 4.0) -- (0.6, 7.8);
		\draw[line width=0.5mm, fill=black](0.5, 7.2) rectangle (0.7, 7.8);
		\centerarc[line width=0.5mm](-1, 4.0)(-20:180:0.6);
		\draw[line width=0.5mm] (-0.755, 3.452) -- (0.792, 2.024);
		\centerarc[line width=0.5mm](0.5, 1.5)(160:380:0.6);
		\draw[line width=0.5mm] (0.956, 1.11) -- (0.6, 8.0);
		\draw[line width=0.5mm](0.5, 1.5) -- (0.75, 0.0);
		\centerarc[line width=0.5mm](1.2, 8.0)(0:180:0.6);
		\draw[line width=0.5mm] (1.8, 8.0) -- (1.75, 0.0);
