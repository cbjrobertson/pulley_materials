...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.15, 10) -- (0.15, 6.0);
		\centerarc[line width=1mm](1, 10)(0:180:0.85);
		\draw[line width=1mm](1.85, 10) -- (1.65, 2.4);
		\centerarc[line width=1mm](2.5, 2.4)(180:270:0.85);
		\draw[line width=1mm](3.336, 2.25) -- (6.1, 1.3);
