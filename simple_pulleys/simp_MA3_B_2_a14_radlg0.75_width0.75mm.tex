...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](-0.5, -2) -- (-2.131, 4.34);
		\centerarc[line width=0.75mm](-2, 3.5)(180:210:0.85);
		\draw[line width=0.75mm](-2.85, 3.5) -- (-2.85, 11.2);
		\centerarc[line width=0.75mm](-2, 11.2)(90:180:0.85);
		
		\draw[line width=0.75mm](-2, 12.05) -- (1, 12.05);
		...
		\draw[line width=0.75mm](4.2, 0.5) -- (5.15, 11.2);
