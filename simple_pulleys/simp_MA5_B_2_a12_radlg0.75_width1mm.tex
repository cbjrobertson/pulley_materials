...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (-5.05, -1.8) -- (-4.35, 9.6);
		\centerarc[line width=1mm](-3.5, 9.6)(0:180:0.85);
		\draw[line width=1mm] (-2.65, 9.6) -- (-2.85, -1.2);
		\centerarc[line width=1mm](-2, -1.2)(180:360:0.85);
		\draw[line width=1mm] (-1.15, -1.2) -- (-1.85, 4.8);
		\draw[line width=1mm] (-1, 4.8) -- (0.35, 9.4);
		\draw[line width=1mm, fill=black](0.25, 8.8) rectangle (0.45, 9.4);
		\centerarc[line width=1mm](-1, 4.8)(-20:180:0.85);
		\draw[line width=1mm] (-0.653, 4.024) -- (0.914, 2.542);
		\centerarc[line width=1mm](0.5, 1.8)(160:380:0.85);
		\draw[line width=1mm] (1.146, 1.248) -- (0.35, 9.6);
		\draw[line width=1mm](0.5, 1.8) -- (0.75, -0.1);
		\centerarc[line width=1mm](1.2, 9.6)(0:180:0.85);
		\draw[line width=1mm] (2.05, 9.6) -- (1.75, -0.1);
