...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (-0.6, 5.5) -- (-0.1, 6.0) -- (0.4, 5.5);
		\draw[fill=black!50] (-1.1, 5.5) rectangle (0.9, 3.5);
		
		\draw[line width=1mm] (-0.1, 9) -- (-0.1, 6.0);
		\centerarc[line width=1mm](1, 9)(0:180:1.1);
		\draw[line width=1mm](2.1, 9) -- (1.4, 0);
		\centerarc[line width=1mm](2.5, 0)(180:360:1.1);
		\draw[line width=1mm](3.6, 0) -- (2.4, 9.6);
		\centerarc[line width=1mm](3.5, 9.6)(0:180:1.1);
		\draw[line width=1mm](4.6, 9.6) -- (4.1, -1.8);
