...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.9, 10) -- (0.9, 3.5);
		\centerarc[line width=1mm](2, 3.5)(180:360:1.1);
		\draw[line width=1mm](3.1, 3.5) -- (2.9, 6.5);
		\centerarc[line width=1mm](4, 6.5)(110:180:1.1);
		\draw[line width=1mm](2.901, 6.452) -- (6.976, 8.95);
		\centerarc[line width=1mm](7, 10.05)(-60:50:1.1);
		\draw[line width=1mm](8.062, 9.762) -- (1.953, 11.665);
		\centerarc[line width=1mm](3, 12)(60:120:1.1);
		\draw[line width=1mm](3.895, 12.639) -- (-1.2, 11.15);
