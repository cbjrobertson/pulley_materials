...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (-0.1, 10) -- (-0.1, 6.0);
		\centerarc[line width=0.75mm](1, 10)(0:180:1.1);
		\draw[line width=0.75mm](2.1, 10) -- (1.4, 2.4);
		\centerarc[line width=0.75mm](2.5, 2.4)(180:270:1.1);
		\draw[line width=0.75mm](3.582, 2.206) -- (6.1, 1.3);
