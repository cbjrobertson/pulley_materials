...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm](1.6, 0.9) -- (2.1, 5.0);
		\draw[line width=0.5mm] (1.5, 10) -- (1.5, 5.0);
		\centerarc[line width=0.5mm](2.1, 5.0)(180:360:0.6);
		\draw[line width=0.5mm](2.7, 5.0) -- (2.7, 7.0);
		\centerarc[line width=0.5mm](3.3, 7.0)(30:180:0.6);
		\draw[line width=0.5mm] (3.822, 7.3) -- (10.5, -2.3);
