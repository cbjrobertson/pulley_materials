...
\begin{document}
	\begin{tikzpicture}
		...
		\centerarc[line width=0.75mm](1, 8)(180:0:0.6)
		\draw[line width=0.75mm](1.6, 8) -- (2.9, 2.0);
		\centerarc[line width=0.75mm](3.5, 2.0)(180:300:0.6);
		\draw[line width=0.75mm](3.487, 1.4) -- (7.987, 3.4);
		\centerarc[line width=0.75mm](8, 4.0)(300:390:0.6);
		\draw[line width=0.75mm](8.542, 4.257) -- (7.05, 7.8);
