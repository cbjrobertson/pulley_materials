...
\begin{document}
	\begin{tikzpicture}
		...
		\centerarc[line width=0.5mm](-2, -1.2)(270:360:1.1);
		\draw[line width=0.5mm] (-0.9, -1.2) -- (-1.1, 4.8);
		\draw[line width=0.5mm] (0, 4.8) -- (0.3, 9.4);
		\draw[line width=0.5mm, fill=black](0.2, 8.8) rectangle (0.4, 9.4);
		\centerarc[line width=0.5mm](0, 4.8)(-20:180:1.1);
		\draw[line width=0.5mm] (0.449, 3.796) -- (1.536, 2.76);
		\centerarc[line width=0.5mm](1, 1.8)(160:380:1.1);
		\draw[line width=0.5mm] (1.836, 1.085) -- (0.3, 9.6);
		\draw[line width=0.5mm](1, 1.8) -- (1.25, -0.1);
		\centerarc[line width=0.5mm](1.4, 9.6)(0:180:1.1);
		\draw[line width=0.5mm] (2.5, 9.6) -- (2.25, -0.1);
