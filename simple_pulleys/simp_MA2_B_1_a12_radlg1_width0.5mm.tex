...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (0.9, 12) -- (0.9, 3.6);
		\centerarc[line width=0.5mm](2, 3.6)(180:330:1.1);
		\draw[line width=0.5mm](0.91, 3.455) -- (3.831, 6.713);
		\centerarc[line width=0.5mm](4, 7.8)(390:325:1.1);
		\draw[line width=0.5mm](4.994, 8.271) -- (2.994, 12.521);
		\centerarc[line width=0.5mm](2, 12.05)(30:90:1.1);
		\draw[line width=0.5mm](2, 13.15) -- (-1, 13.15);
