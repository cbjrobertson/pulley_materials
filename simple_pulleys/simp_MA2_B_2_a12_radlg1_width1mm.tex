...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.9, 12) -- (0.9, 4.2);
		\centerarc[line width=1mm](2, 4.2)(180:360:1.1);
		\draw[line width=1mm](3.1, 4.2) -- (2.9, 7.8);
		\centerarc[line width=1mm](4, 7.8)(110:180:1.1);
		\draw[line width=1mm](2.901, 7.752) -- (6.976, 10.95);
		\centerarc[line width=1mm](7, 12.05)(-60:50:1.1);
		\draw[line width=1mm](8.062, 11.762) -- (1.953, 13.665);
		\centerarc[line width=1mm](3, 14)(60:120:1.1);
		\draw[line width=1mm](3.895, 14.639) -- (-1.2, 13.15);
