...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (0.4, 12) -- (0.4, 7.0);
		\centerarc[line width=0.75mm](1, 12)(0:180:0.6);
		\draw[line width=0.75mm](1.6, 12) -- (1.9, 2.8);
		\centerarc[line width=0.75mm](2.5, 2.8)(180:270:0.6);
		\draw[line width=0.75mm](3.09, 2.694) -- (6.1, 1.3);
