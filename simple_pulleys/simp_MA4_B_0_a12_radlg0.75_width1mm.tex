...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.35, 13) --  (0.15, 3.6);
		\centerarc[line width=1mm](1, 3.6)(180:360:0.85);
		\draw[line width=1mm] (1.85, 3.6) -- (1.4, 8.4);
		\centerarc[line width=1mm](2.25, 8.4)(-20:180:0.85);
		\draw[line width=1mm](3.075, 8.23) -- (2.65, 3.685);
		\centerarc[line width=1mm](3.5, 3.6)(160:360:0.85);
		\draw[line width=1mm](4.35, 3.6) -- (4.25, 12);
