...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (3.5, 2.4) -- (3.0, 0);
		...
		\centerarc[line width=1mm](1, 10)(180:0:0.6)
		\draw[line width=1mm](1.6, 10) -- (2.9, 2.4);
		\centerarc[line width=1mm](3.5, 2.4)(180:300:0.6);
		\draw[line width=1mm](3.487, 1.8) -- (7.987, 4.2);
		\centerarc[line width=1mm](8, 4.8)(300:390:0.6);
		\draw[line width=1mm](8.542, 5.057) -- (7.05, 9.8);
