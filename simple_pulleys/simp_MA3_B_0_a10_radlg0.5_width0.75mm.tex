...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](-0.7, -1.9) -- (0.4, 8.5);
		\centerarc[line width=0.75mm](1, 8.5)(0:180:0.6);
		\draw[line width=0.75mm](1.6, 8.5) -- (2.1, 2.5);
		\centerarc[line width=0.75mm](2.7, 2.5)(180:370:0.6);
		\draw[line width=0.75mm] (3.3, 2.49) -- (3.7, 8.5);
		\centerarc[line width=0.75mm](4.3, 8.5)(0:180:0.6);
		\draw[line width=0.75mm](4.2, 0.4) -- (4.9, 8.5);
