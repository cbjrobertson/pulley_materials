...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm](-0.5, -2) -- (-2.092, 3.093);
		\centerarc[line width=0.75mm](-2, 2.5)(180:210:0.6);
		\draw[line width=0.75mm](-2.6, 2.5) -- (-2.6, 8.0);
		\centerarc[line width=0.75mm](-2, 8.0)(90:180:0.6);
		
		\draw[line width=0.75mm](-2, 8.6) -- (1, 8.6);
		...
		\draw[line width=0.75mm](4.2, 0.5) -- (4.9, 8.0);
