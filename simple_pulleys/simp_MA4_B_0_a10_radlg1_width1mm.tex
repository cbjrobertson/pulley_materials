...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.35, 11) --  (-0.1, 3.0);
		\centerarc[line width=1mm](1, 3.0)(180:360:1.1);
		\draw[line width=1mm] (2.1, 3.0) -- (1.15, 7.0);
		\centerarc[line width=1mm](2.25, 7.0)(-20:180:1.1);
		\draw[line width=1mm](3.317, 6.78) -- (2.4, 3.11);
		\centerarc[line width=1mm](3.5, 3.0)(160:360:1.1);
