...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (-0.25, 5.6) -- (0.3, 11.0);
		\draw[line width=0.5mm, fill=black](0.2, 10.4) rectangle (0.4, 11.0);
		\draw[line width=0.5mm] (-1.55, -1.8) -- (0.547, 5.895);
		\centerarc[line width=0.5mm](-0.25, 5.6)(-20:170:0.85);
		\draw[line width=0.5mm] (0.097, 4.824) -- (1.164, 2.842);
		\centerarc[line width=0.5mm](0.75, 2.1)(160:380:0.85);
		\draw[line width=0.5mm] (1.396, 1.547) -- (0.3, 11.2);
		\draw[line width=0.5mm](0.75, 2.1) -- (1.25, -0.2);
		\centerarc[line width=0.5mm](1.15, 11.2)(0:180:0.85);
