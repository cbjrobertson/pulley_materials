...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm] (0.45, 11) -- (-2.935, 7.605);
		\centerarc[line width=1mm](-2, 7.0)(135:180:1.1);
		\draw[line width=1mm] (-3.1, 7.0) -- (-3.1, 3.0);
		\centerarc[line width=1mm](-2, 3.0)(180:270:1.1);
		\draw[line width=1mm](-2, 1.9) -- (1, 1.9);
		\centerarc[line width=1mm](1, 3.0)(270:360:1.1);
		\draw[line width=1mm] (2.1, 3.0) -- (1.9, 7.0);
		\centerarc[line width=1mm](3, 7.0)(-20:180:1.1);
		\draw[line width=1mm](4.067, 6.78) -- (2.9, 3.11);
		\centerarc[line width=1mm](4, 3.0)(160:360:1.1);
		\draw[line width=1mm](5.1, 3.0) -- (5.0, 10);
