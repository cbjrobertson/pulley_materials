...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](-0.5, -2) -- (-2.092, 4.093);
		\centerarc[line width=1mm](-2, 3.5)(180:210:0.6);
		\draw[line width=1mm](-2.6, 3.5) -- (-2.6, 11.2);
		\centerarc[line width=1mm](-2, 11.2)(90:180:0.6);
		
		\draw[line width=1mm](-2, 11.8) -- (1, 11.8);
		\centerarc[line width=1mm](1, 11.2)(0:90:0.6);
		\draw[line width=1mm](1.6, 11.2) -- (2.1, 3.5);
		\centerarc[line width=1mm](2.7, 3.5)(180:370:0.6);
		\draw[line width=1mm] (3.3, 3.49) -- (3.7, 11.2);
		\centerarc[line width=1mm](4.3, 11.2)(0:180:0.6);
		\draw[line width=1mm](4.2, 0.5) -- (4.9, 11.2);
