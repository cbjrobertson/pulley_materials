...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (-2.1, 11.735) -- (-0.829, 4.582);
		...
		\draw[line width=0.5mm](9.274, 5.759) -- (7.232, -0.872);
		\centerarc[line width=0.5mm](8.2, -1.4)(150:280:1.1);
		\draw[line width=0.5mm](7.186, -1.827) -- (11, -1.8);
