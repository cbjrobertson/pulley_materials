...
\begin{document}
	\begin{tikzpicture}
		...
		\centerarc[line width=0.5mm](-2, -1.2)(270:360:0.6);
		\draw[line width=0.5mm] (-1.4, -1.2) -- (-0.6, 4.8);
		\draw[line width=0.5mm] (0, 4.8) -- (0.8, 9.4);
		\draw[line width=0.5mm, fill=black](0.7, 8.8) rectangle (0.9, 9.4);
		\centerarc[line width=0.5mm](0, 4.8)(-20:180:0.6);
		\draw[line width=0.5mm] (0.245, 4.252) -- (1.292, 2.324);
		\centerarc[line width=0.5mm](1, 1.8)(160:380:0.6);
		\draw[line width=0.5mm] (1.456, 1.41) -- (0.8, 9.6);
		\draw[line width=0.5mm](1, 1.8) -- (1.25, -0.1);
		\centerarc[line width=0.5mm](1.4, 9.6)(0:180:0.6);
