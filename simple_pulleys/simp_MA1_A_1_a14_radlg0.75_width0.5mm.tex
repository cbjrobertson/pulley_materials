...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.5mm] (0.15, 12) -- (0.15, 7.0);
		\centerarc[line width=0.5mm](1, 12)(0:180:0.85);
		\draw[line width=0.5mm](1.85, 12) -- (1.65, 2.8);
		\centerarc[line width=0.5mm](2.5, 2.8)(180:270:0.85);
		\draw[line width=0.5mm](3.336, 2.65) -- (6.1, 1.3);
