...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (3, 16) -- (3, 18);
		
		\draw (2, 4.9) -- (2, 2.9) -- (1.5, 2.4) -- (2.5, 2.4) -- (2, 2.9);
		\draw[fill=black!50] (0.95, 2.4) rectangle (3.05, 0.4);
		
		\draw[line width=0.75mm] (1.15, 14) -- (1.15, 4.9);
		\centerarc[line width=0.75mm](2, 4.9)(180:360:0.85);
		\draw[line width=0.75mm](2.85, 4.9) -- (3.15, 9.1);
		\centerarc[line width=0.75mm](4, 9.1)(110:180:0.85);
		\draw[line width=0.75mm](3.151, 9.063) -- (6.981, 13.2);
		\centerarc[line width=0.75mm](7, 14.05)(-60:50:0.85);
		\draw[line width=0.75mm](7.82, 13.827) -- (2.191, 15.741);
		\centerarc[line width=0.75mm](3, 16)(60:120:0.85);
		\draw[line width=0.75mm](3.692, 16.494) -- (-1.2, 15.15);
