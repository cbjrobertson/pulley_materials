...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=1mm](-0.7, -1.9) --  (-2.35, 7.9);
		\centerarc[line width=1mm](-1.5, 7.9)(90:180:0.85);
		\draw[line width=1mm](-1.5, 8.75) -- (1, 8.85);
		...
		\draw[line width=1mm](4.2, 0.4) -- (5.15, 8.0);
