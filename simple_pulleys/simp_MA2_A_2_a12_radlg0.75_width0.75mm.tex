...
\begin{document}
	\begin{tikzpicture}
		...
		\draw[line width=0.75mm] (0.15, 12) -- (0.15, 3.6);
		\centerarc[line width=0.75mm](1, 3.6)(180:360:0.85);
		\draw[line width=0.75mm](1.85, 3.6) -- (2.35, 9.6);
		\centerarc[line width=0.75mm](3.2, 9.6)(0:180:0.85);
		\draw[line width=0.75mm](4.05, 9.6) -- (5.15, -1);
		\centerarc[line width=0.75mm](6, -1)(180:360:0.85);
		\draw[line width=0.75mm](6.85, -1) -- (7.15, 2.4);
		\centerarc[line width=0.75mm](8, 2.4)(0:180:0.85);
		\draw[line width=0.75mm](8.85, 2.4) -- (9.1, -1.8);
